...
Falling is not [forced movement](../../movement/forced-movement.md), but being force moved downward is considered falling. Movement from falling doesn't provoke [opportunity attacks](../combat/opportunity-attack.md) (see [Opportunity Attacks](../combat/opportunity-attack.md) below).
