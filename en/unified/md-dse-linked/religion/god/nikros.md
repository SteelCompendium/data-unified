...
domains:
    ...
    - Storm
    - War
file_basename: nikros
file_dpath: religion/god
god_class: younger
item_id: nikros
item_name: Nikros the Tyrant
name: Nikros the Tyrant
pantheon: vasloria
scc: mcdm.heroes.v1/religion.god/nikros
...
Nikros believes that strength is the only virtue, and those who are born strong were born to rule. Because of this, [followers](../../rule/general/follower.md) of Nikros are often mistaken for [followers](../../rule/general/follower.md) of [Adûn](adun.md)—a mask they are happy to wear. Both teach that strength is good. But for [Adûn](adun.md) strength is a tool for helping others. For Nikros, strength is power to enact your will heedless of the consequences. [Might](../../rule/character/might.md) is right.
