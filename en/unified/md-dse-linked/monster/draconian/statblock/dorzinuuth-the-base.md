...
features:
    - ability_type: Signature Ability
      ...
      effects:
        - roll: Power Roll + 4
          ...
          tier2: 16 damage; M < 3 [prone](../../../condition/prone.md)
          tier3: 19 damage; M < 4 [prone](../../../condition/prone.md)
    ...
    - distance: 5 x 2 line within 1
      effects:
        - roll: Power Roll + 4
          tier1: 7 damage
          tier2: 13 damage; M < 3 [prone](../../../condition/prone.md)
          tier3: 15 damage; M < 4 [prone](../../../condition/prone.md)
      feature_type: ability
      icon: "\U0001F533"
      keywords:
        - Area
    ...
    - effects:
      ...
      type: feature
    - effects:
        - effect: If Dorzinuuth hears a creature recite the Dragon Phalanx oath, he takes a [bane](../../../rule/dice/bane.md) on strikes made against that character until the end of the encounter.
      feature_type: trait
      icon: ⭐️
      name: Remember Your Oath
      type: feature
    - effects:
        - effect: While Dorzinuuth isn't [flying](../../../movement/fly.md), strikes made against him take a [bane](../../../rule/dice/bane.md).
      feature_type: trait
      icon: ⭐️
    ...
    - cost: Villain Action 2
      distance: 10 burst
      effects:
        - effect: '**Effect:** Each target [shifts](../../../movement/shifting.md) or [flies](../../../movement/fly.md) up to their speed and regains 10 [Stamina](../../../rule/health/stamina.md).'
      feature_type: ability
      icon: ☠️
      keywords:
        - Area
