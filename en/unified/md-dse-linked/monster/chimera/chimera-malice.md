...
features:
    - body: The chimera takes up a defensive stance. Until the start of their next turn, the chimera can make a [free strike](../../feature/common/main-actions/free-strike.md) against each enemy who comes within 2 squares of them.
      cost: 3 Malice
      effects:
        - effect: The chimera takes up a defensive stance. Until the start of their next turn, the chimera can make a [free strike](../../feature/common/main-actions/free-strike.md) against each enemy who comes within 2 squares of them.
      icon: ⭐️
    ...
    - body: The chimera takes an additional main action on their turn. They can use this feature even if they are [dazed](../../condition/dazed.md).
      cost: 5 Malice
      effects:
        - effect: The chimera takes an additional main action on their turn. They can use this feature even if they are [dazed](../../condition/dazed.md).
      icon: ☠️
      name: Solo Action
    - body: The chimera shakes the ground, causing an eruption of loose rocks and debris that creates three size 2 stone objects anywhere on the encounter map. Each creature [adjacent](../../rule/combat/adjacent.md) to one or more objects when they appear who has A < 2 takes 5 damage.
      cost: 5 Malice
      effects:
        - effect: The chimera shakes the ground, causing an eruption of loose rocks and debris that creates three size 2 stone objects anywhere on the encounter map. Each creature [adjacent](../../rule/combat/adjacent.md) to one or more objects when they appear who has A < 2 takes 5 damage.
      icon: "\U0001F533"
