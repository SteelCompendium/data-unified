...
features:
    ...
    - distance: Ranged 5
      ...
      usage: Main action
    - effects:
        - effect: Whenever the skyterror moves 2 or more squares along the ground or falls 2 or more squares, they can [fly](../../../movement/fly.md) until the end of their next turn.
      feature_type: trait
      icon: ⭐️
      name: Glider
      type: feature
    - effects:
        - effect: While the skyterror has a tail, whenever they are [grabbed](../../../condition/grabbed.md), [prone](../../../condition/prone.md), [slowed](../../../condition/slowed.md), or [weakened](../../../condition/weakened.md), they can lose their tail to immediately end that condition, then [shift](../../../movement/shifting.md) up to 2 squares.
      feature_type: trait
      icon: ⭐️
