...
features:
    - ability_type: Signature Ability
      ...
      effects:
        - roll: Power Roll + 2
          tier1: 5 damage; A < 0 [restrained](../../../condition/restrained.md) (save ends)
          tier2: 7 damage; A < 1 [restrained](../../../condition/restrained.md) (save ends)
          tier3: 9 damage; A < 2 [restrained](../../../condition/restrained.md) (save ends)
    ...
    - cost: 2 Malice
      ...
      usage: Main action
    - effects:
        - effect: While the bloodeye has a tail, whenever they are [grabbed](../../../condition/grabbed.md), [prone](../../../condition/prone.md), [slowed](../../../condition/slowed.md), or [weakened](../../../condition/weakened.md), they can lose their tail to immediately end that condition, then [shift](../../../movement/shifting.md) up to 2 squares.
      feature_type: trait
      icon: ⭐️
