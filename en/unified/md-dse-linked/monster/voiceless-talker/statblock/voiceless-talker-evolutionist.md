...
features:
    - ability_type: Signature Ability
      ...
      effects:
        - roll: Power Roll + 4
          tier1: 11 psychic damage; R < 2 [slowed](../../../condition/slowed.md) (save ends)
          tier2: 16 psychic damage; R < 3 [slowed](../../../condition/slowed.md) (save ends)
          tier3: 19 psychic damage; R < 4 [slowed](../../../condition/slowed.md) (save ends)
    ...
    - effects:
        - effect: At the end of each of their turns, the evolutionist can take 10 damage to end one effect on them that can be ended by a [saving throw](../../../rule/general/saving-throw.md). This damage can't be reduced in any way.
      feature_type: trait
      icon: ⭐️
      name: End Effect
      type: feature
    - effects:
        - effect: The evolutionist has any trait of the Director's choice from any ally [minion](../../../rule/organization/minion.md) in the encounter.
      feature_type: trait
      icon: ⭐️
