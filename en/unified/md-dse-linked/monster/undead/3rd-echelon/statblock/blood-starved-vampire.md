...
features:
    - ability_type: Signature Ability
      ...
      usage: Main action
    - effects:
        - effect: The blood-starved vampire has speed 10 while any creature within 10 squares of them is [bleeding](../../../../condition/bleeding.md). The vampire must use Feeding Frenzy against a [bleeding](../../../../condition/bleeding.md) creature on their turn if they are able to.
      feature_type: trait
      icon: ⭐️
