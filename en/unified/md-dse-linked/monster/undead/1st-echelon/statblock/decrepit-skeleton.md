...
features:
    - ability_type: Signature Ability
      ...
      usage: Main action
    - effects:
        - effect: When the decrepit skeleton is reduced to 0 [Stamina](../../../../rule/health/stamina.md), their space is [difficult terrain](../../../../movement/difficult-terrain.md). The first time any enemy enters this space, the take 1 damage and the effect end.
      feature_type: trait
      icon: ⭐️
      name: Bonetrops
      type: feature
