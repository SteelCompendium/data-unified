...
features:
    - ability_type: Signature Ability
      ...
      usage: Main action
    - effects:
        - effect: Whenever an [adjacent](../../../rule/combat/adjacent.md) enemy [grabs](../../../condition/grabbed.md) the fireballer or uses a melee ability against them, that enemy takes 5 fire damage.
      feature_type: trait
      icon: ⭐️
      name: Searing Skin
      type: feature
