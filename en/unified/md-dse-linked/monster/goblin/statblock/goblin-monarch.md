...
features:
    ...
    - effects:
        - effect: The monarch doesn't provoke [opportunity attacks](../../../rule/combat/opportunity-attack.md) by moving.
      feature_type: trait
      icon: ⭐️
      name: Crafty
      type: feature
    ...
    - cost: Villain Action 1
      distance: 10 burst
      effects:
        - effect: '**Effect:** Each target can move up to their speed or make a [free strike](../../../feature/common/main-actions/free-strike.md).'
      feature_type: ability
      icon: ☠️
      keywords:
        - Area
    ...
    - cost: Villain Action 3
      distance: Special
      effects:
        - effect: '**Effect:** Each enemy in the encounter takes 2 damage for each goblin [adjacent](../../../rule/combat/adjacent.md) to them.'
      feature_type: ability
      icon: ☠️
      keywords: []
      name: Kill!
