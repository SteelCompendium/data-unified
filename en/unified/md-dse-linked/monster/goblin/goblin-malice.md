...
features:
    ...
    - body: Each enemy in the encounter takes 1 damage for each goblin [adjacent](../../rule/combat/adjacent.md) to them.
      cost: 5 Malice
      effects:
        - effect: Each enemy in the encounter takes 1 damage for each goblin [adjacent](../../rule/combat/adjacent.md) to them.
      icon: ❇️
      name: Tiny Stabs
    - cost: 7 Malice
      effects:
        - effect: The encounter map is covered in a green mist that lasts until the end of the round, and which can't be dispersed by wind. All areas of the map are [difficult terrain](../../movement/difficult-terrain.md) for non-goblins, and each non-goblin on the map makes a **Might test**.
          tier1: 5 poison damage; the creature is [weakened](../../condition/weakened.md) until the mist disappears.
          tier2: The creature is [weakened](../../condition/weakened.md) until the mist disappears.
          tier3: No effect.
      icon: "\U0001F300"
