...
features:
    ...
    - cost: Encounter
      ...
      usage: Move Action
    - effects:
        - effect: The vampire rebel has speed 10 while any creature within 10 squares of them is [bleeding](../../../condition/bleeding.md). If the vampire rebel is able to deal damage to a [bleeding](../../../condition/bleeding.md) creature on their turn and does not do so, they take 5 corruption damage at the end of their turn.
      feature_type: trait
      icon: ⭐️
