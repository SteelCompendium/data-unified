...
features:
    ...
    - cost: 2 Malice
      ...
      effects:
        - roll: ""
          tier1: 3 poison damage; the target is wet and [weakened](../../../condition/weakened.md) (save ends)
          tier2: 2 poison damage; the target is wet (save ends)
          tier3: 1 poison damage; the target is wet ([EoT](../../../rule/combat/end-of-turn.md))
      feature_type: ability
      icon: "\U0001F533"
      keywords:
        - Area
      ...
      usage: Main action
    - effects:
        - effect: Whenever an adjacent enemy [grabs](../../../feature/common/maneuvers/grab.md) the wave or uses a melee ability against them, that enemy takes 2 poison damage.
      feature_type: trait
      icon: ⭐️
      name: Toxiferous
      type: feature
