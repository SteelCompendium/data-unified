...
features:
    ...
    - cost: Villain Action 2
      distance: 1 burst
      effects:
        - effect: '**Effect:** Before using this [villain action](../../../rule/monster/villain-action.md), the hag [shifts](../../../movement/shifting.md) up to their speed. They then use Corrosive Claws against each target, [push](../../../movement/forced-movement.md) each target up to 2 squares, and [shift](../../../movement/shifting.md) up to their speed again.'
      feature_type: ability
      icon: ☠️
      keywords:
        - Area
