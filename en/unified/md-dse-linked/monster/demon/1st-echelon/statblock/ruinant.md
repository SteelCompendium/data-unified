...
features:
    ...
    - cost: 3 Malice
      distance: Ranged 10
      effects:
        - effect: Each target must be at less than full [Stamina](../../../../rule/health/stamina.md).
          name: Special
          roll: Power Roll + 2
      ...
      usage: Maneuver
    - effects:
        - effect: While the ruinant is [winded](../../../../rule/health/winded.md), they gain an [edge](../../../../rule/dice/edge.md) on strikes, and any strike made against them gains an edge.
      feature_type: trait
      icon: ⭐️
      name: Lethe
      type: feature
