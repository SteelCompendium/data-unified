...
features:
    - ability_type: Signature Ability
      ...
      effects:
        ...
        - cost: 2 Malice
          effect: Two ensnarers appear in unoccupied spaces [adjacent](../../../../rule/combat/adjacent.md) to each target. On a tier 3 outcome, four ensnarers appear.
    ...
    - cost: 2 Malice
      ...
      effects:
        - effect: Four level 1 demon [minions](../../../../rule/organization/minion.md) (most commonly ensnarers, frenzieds, and pitlings) burst forth from the egress and appear in unoccupied spaces in the area.
          name: Effect
        - cost: 2 Malice
          effect: Four level 4 demon [minions](../../../../rule/organization/minion.md) (most commonly orliq, grulqins, and wobalas) appear instead.
      feature_type: ability
      icon: ❇️
      keywords:
        - Area
