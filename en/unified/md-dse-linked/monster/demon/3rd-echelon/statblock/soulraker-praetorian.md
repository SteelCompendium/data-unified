...
features:
    ...
    - effects:
        - effect: While the praetorian is [winded](../../../../rule/health/winded.md), they gain an [edge](../../../../rule/dice/edge.md) on strikes, and any strike made against them gains an edge.
      feature_type: trait
      icon: ⭐️
      name: Lethe
      type: feature
    - effects:
        - effect: Any creature who starts their turn with two or more praetorians [adjacent](../../../../rule/combat/adjacent.md) to them takes 6 sonic damage.
      feature_type: trait
      icon: ⭐️
