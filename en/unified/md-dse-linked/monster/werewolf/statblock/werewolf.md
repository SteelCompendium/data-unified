...
features:
    - effects:
        - effect: At the end of each of their turns, the werewolf can take 5 damage to end one effect on them that can be ended by a [saving throw](../../../rule/general/saving-throw.md). This damage can't be reduced in any way.
          name: End Effect
    ...
    - cost: Villain Action 3
      ...
      effects:
        ...
        - effect: The werewolf [shifts](../../../movement/shifting.md) up to their speed before and after using this ability.
          name: Effect
      feature_type: ability
      icon: ☠️
      keywords:
