...
features:
    ...
    - distance: Ranged 5
      ...
      usage: Maneuver
    - effects:
        - effect: When the trooper is reduced to 0 [Stamina](../../../rule/health/stamina.md), they spray burning blood. Each creature [adjacent](../../../rule/combat/adjacent.md) to the trooper takes 3 fire damage.
      feature_type: trait
      icon: ⭐️
      name: Infernal Ichor
      type: feature
