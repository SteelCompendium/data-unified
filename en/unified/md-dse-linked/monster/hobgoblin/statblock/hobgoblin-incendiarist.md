...
features:
    ...
    - cost: 3 Malice
      ...
      usage: Main action
    - effects:
        - effect: The ranged [free strike](../../../feature/common/main-actions/free-strike.md) of each ally within 3 squares of the incendiarist has a distance of 10 and deals fire damage.
      feature_type: trait
      icon: ⭐️
      name: Raining Cinders
      type: feature
    - effects:
        - effect: When the incendiarist is reduced to 0 [Stamina](../../../rule/health/stamina.md), they spray burning blood. Each creature [adjacent](../../../rule/combat/adjacent.md) to the incendiarist takes 3 fire damage.
      feature_type: trait
      icon: ⭐️
      name: Infernal Ichor
      type: feature
