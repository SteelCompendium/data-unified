...
In spite of their friendly, outgoing nature, the rare presence of a [hakaan](scc.v1:mcdm.heroes.v1/ancestry/hakaan) in [human](scc.v1:mcdm.heroes.v1/ancestry/human) society is considered a harbinger. An omen of dark times.

Descended from a tribe of giants in upper Vanigar, the original Haka'an tribe made a bargain with Holkatya the Vanigar trickster god. They traded some of their gigantic [size](scc.v1:mcdm.heroes.v1/rule.character/size) and strength for the ability to see the future.

But Holkatya betrayed them, and the only future a [hakaan](scc.v1:mcdm.heroes.v1/ancestry/hakaan) is allowed to see is the moment and nature of their own death. These visions are never of some mundane tragedy. No [hakaan](scc.v1:mcdm.heroes.v1/ancestry/hakaan) ever received a vision of [dying](scc.v1:mcdm.heroes.v1/rule.health/dying) from choking on a grape. This Doomsight is always momentous. Always dramatic.

The Doomsight can happen at any moment. It does not come for all or even most [hakaan](scc.v1:mcdm.heroes.v1/ancestry/hakaan), but when it comes, it is considered an act of overwhelming hubris to ignore it. Trying to escape the Doomsight means a painful, tragic death, and cursing your family to live with shame.

But the only [hakaan](scc.v1:mcdm.heroes.v1/ancestry/hakaan) the average [human](scc.v1:mcdm.heroes.v1/ancestry/human) meets is one trying to fulfill their doom. The [human](scc.v1:mcdm.heroes.v1/ancestry/human) superstition—that the arrival of one or more [hakaan](scc.v1:mcdm.heroes.v1/ancestry/hakaan) in [human](scc.v1:mcdm.heroes.v1/ancestry/human) lands is a sign of great forces acting in the world, auspicious times—is literally true. In dark times, many [hakaan](scc.v1:mcdm.heroes.v1/ancestry/hakaan) experience the Doomsight and leave their communities to venture out into the mundane world, in search of their destiny.

[Humans](scc.v1:mcdm.heroes.v1/ancestry/human) in Vanigar have their own word for this concept of a personal fate. "Wyrd." Traditional [hakaan](scc.v1:mcdm.heroes.v1/ancestry/hakaan) sometimes refer to the Doomsight as "wyrdken."

### On Hakaan

The gate, or door, or whatever it was started to close. With Dazar on the other side of it.

"Embers!" John called out, but the [high elf](scc.v1:mcdm.heroes.v1/ancestry/high-elf) was surrounded. At that moment, a detonation. An explosion of sound that knocked the demons back. And a giant stood before the lumbering egress.

Dust settled on the ground behind the giant, and John realized the thunderclap was the sound of the giant running to them. Air that couldn't get out of the way fast enough, tortured by the pressure of his [speed](scc.v1:mcdm.heroes.v1/rule.character/speed).

The rectangular, toothed egress demon was twelve feet tall at least, the giant almost matching its immense [size](scc.v1:mcdm.heroes.v1/rule.character/size).
...
But the arrival of the giant changed the equation. John saw a new solution. The [hakaan](scc.v1:mcdm.heroes.v1/ancestry/hakaan) risked his life to buy them options, and Sir John of Tor would not let the giant risk his life in vain.
...
The [hakaan](scc.v1:mcdm.heroes.v1/ancestry/hakaan) struggled against the living gateway to that blasted world. One leg buckled and the stone warrior fell to one knee. The door would take him just as it took their [dwarf](scc.v1:mcdm.heroes.v1/ancestry/dwarf) [conduit](scc.v1:mcdm.heroes.v1/class/conduit).

Then, rising behind the egress demon, the high theocron, his battlestaff glowing.

"Back!" Dazar [conduit](scc.v1:mcdm.heroes.v1/class/conduit) of Zarok, Law-Giver shouted, smashing at the flesh of the living doorway with his battlestaff. "To hell!" He swung again.
...
They only had a moment before the demons swarmed them, but a moment was all it took before the [hakaan](scc.v1:mcdm.heroes.v1/ancestry/hakaan) shouted and finally ripped the bloody egress demon apart with his bare hands.
...
"Ajax," Dazar said. And the [hakaan](scc.v1:mcdm.heroes.v1/ancestry/hakaan) could hear the darkness in his voice.
...
"No armor, no sword or staff," Dazar noticed. "[Hakaan](scc.v1:mcdm.heroes.v1/ancestry/hakaan) do not use weapons?"
...
"He's a [null](scc.v1:mcdm.heroes.v1/class/null)," Embers explained. "They eschew all weapons and [implements](scc.v1:mcdm.heroes.v1/rule.treasure/implement) of war. It is part of their creed, as I understand it."

"Strength alone might serve," Dazar nodded, "when the strength is such as yours."

Ardashir grinned. "Strength alone is not enough." He assumed a fighting pose, hands clenched, arms in a guarding position before him. "Discipline, training, focus. These are my [implements](scc.v1:mcdm.heroes.v1/rule.treasure/implement)."
