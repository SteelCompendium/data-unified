...
features:
    - effects:
        - effect: As a maneuver, a creature [adjacent](scc.v1:mcdm.heroes.v1/rule.combat/adjacent) to an iron dragon can make an **Agility test**.
          tier1: The creature accidentally activates the **Gout of Flame** ability.
          tier2: The iron dragon is deactivated but the creature is [slowed](scc.v1:mcdm.heroes.v1/condition/slowed) (EoT).
    ...
    - distance: 8 x 2 line within 1
      effects:
        - roll: Power Roll + 2
          tier1: 6 fire damage; A < 0 the target is burning ([save](scc.v1:mcdm.heroes.v1/rule.general/saving-throw) ends)
          tier2: 10 fire damage; A < 1 the target is burning ([save](scc.v1:mcdm.heroes.v1/rule.general/saving-throw) ends)
          tier3: 13 fire damage; A < 2 the target is burning ([save](scc.v1:mcdm.heroes.v1/rule.general/saving-throw) ends)
