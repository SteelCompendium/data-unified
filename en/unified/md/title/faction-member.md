...
- *Academic Faction:* You find a sage who can make up to three [Reason](scc.v1:mcdm.heroes.v1/rule.character/reason) [tests](scc.v1:mcdm.heroes.v1/rule.test/test) to recall lore or make [project rolls](scc.v1:mcdm.heroes.v1/rule.downtime/project-roll) for [research projects](scc.v1:mcdm.heroes.v1/rule.downtime/research-project) on your behalf. The sage has a +5 [bonus](scc.v1:mcdm.heroes.v1/rule.dice/bonuses-and-penalties) to these [tests](scc.v1:mcdm.heroes.v1/rule.test/test). These [project rolls](scc.v1:mcdm.heroes.v1/rule.downtime/project-roll) take 10 minutes each and don't need to be made during a [respite](scc.v1:mcdm.heroes.v1/rule.resource/respite).
- *Guild Faction:* You find an expert crafter who can make up to three [project rolls](scc.v1:mcdm.heroes.v1/rule.downtime/project-roll) for [crafting projects](scc.v1:mcdm.heroes.v1/rule.downtime/crafting-project) on your behalf. The crafter has a +5 [bonus](scc.v1:mcdm.heroes.v1/rule.dice/bonuses-and-penalties) to these [tests](scc.v1:mcdm.heroes.v1/rule.test/test). These [project rolls](scc.v1:mcdm.heroes.v1/rule.downtime/project-roll) take 10 uninterrupted minutes each and don't need to be made during a [respite](scc.v1:mcdm.heroes.v1/rule.resource/respite).
- *Martial Faction:* You recruit up to three minions with levels no greater than your own, of a type appropriate for the faction (such as **[human](scc.v1:mcdm.heroes.v1/ancestry/human) guards**). These minions follow your orders for a day.
