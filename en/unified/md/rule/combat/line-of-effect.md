...
To target a creature or object with an ability or effect, including making a [strike](scc.v1:mcdm.heroes.v1/rule.combat/strike) against them, you must have line of effect to that target. If any solid object, such as a wall or pillar, completely blocks the target from you, then you don't have line of effect.
