...
The Director should make an agenda for a campaign's first session often called "session zero." Chapter 15: [For the Director](scc.v1:mcdm.heroes.v1/chapter/for-the-director) has all the information a Director needs to help organize a successful first session, which can include any of the following events:
...
- The Director should tell the players if any options are limited or rare in their campaign. For example, some Directors don't want psionics to appear in their game worlds, so they might decide that heroes can't be [nulls](scc.v1:mcdm.heroes.v1/class/null) or [talents](scc.v1:mcdm.heroes.v1/class/talent). Another campaign might be grounded in more typical medieval fantasy and not have any [memonek](scc.v1:mcdm.heroes.v1/ancestry/memonek) or [time raiders](scc.v1:mcdm.heroes.v1/ancestry/time-raider), or those ancestries might be exceedingly rare. In the latter case, players should know that their [memonek](scc.v1:mcdm.heroes.v1/ancestry/memonek) or [time raider](scc.v1:mcdm.heroes.v1/ancestry/time-raider) heroes are likely to get a lot of questions from curious [NPCs](scc.v1:mcdm.heroes.v1/rule.general/npc).
...
Choose your hero's humanoid ancestry from among the range of ancestries available in the game—[devil](scc.v1:mcdm.heroes.v1/ancestry/devil), [dragon knight](scc.v1:mcdm.heroes.v1/ancestry/dragon-knight), [dwarf](scc.v1:mcdm.heroes.v1/ancestry/dwarf), [wode elf](scc.v1:mcdm.heroes.v1/ancestry/wode-elf), [high elf](scc.v1:mcdm.heroes.v1/ancestry/high-elf), [hakaan](scc.v1:mcdm.heroes.v1/ancestry/hakaan), [human](scc.v1:mcdm.heroes.v1/ancestry/human), [memonek](scc.v1:mcdm.heroes.v1/ancestry/memonek), [orc](scc.v1:mcdm.heroes.v1/ancestry/orc), [polder](scc.v1:mcdm.heroes.v1/ancestry/polder), [revenant](scc.v1:mcdm.heroes.v1/ancestry/revenant), or [time raider](scc.v1:mcdm.heroes.v1/ancestry/time-raider). Future supplements will introduce additional ancestries you can choose from. See Chapter 3: [Ancestries](scc.v1:mcdm.heroes.v1/chapter/ancestries) for more information.

#### 3. Culture

Choose or create your hero's culture. Although ancestry gives your hero any number of physiological benefits, your culture describes the community that raised you and gives you languages and skills. See Culture in Chapter 4: [Background](scc.v1:mcdm.heroes.v1/chapter/background) for more information.

> **Choosing Skills**
>
> This game has lots of skills (as detailed in Skills in Chapter 9: [Tests](scc.v1:mcdm.heroes.v1/chapter/tests)), and lots of opportunities during character creation to gain them. We recommend recording a list of all the skills you might choose from the different steps of the character creation process, then making your choices at the end of that process rather than flipping back and forth through the book.
...
Choose your hero's career, which describes what you did for a living before you became a hero. A career provides you with skills, an inciting incident that precipitated your adventuring career, and a perk that lets you customize your hero. It might also grant you languages, [Renown](scc.v1:mcdm.heroes.v1/rule.resource/renown), wealth, or the potential to undertake crafting and research. See [Careers](scc.v1:mcdm.heroes.v1/chapter/background) in Chapter 4: [Background](scc.v1:mcdm.heroes.v1/chapter/background) for more information.
...
Choose your hero's class. This choice has the biggest impact on how your hero interacts with the rules of the game, particularly the rules for combat. Your class provides your starting [characteristic](scc.v1:mcdm.heroes.v1/rule.character/characteristic) scores that determine your character's physical and mental acumen, as well as the [Stamina](scc.v1:mcdm.heroes.v1/rule.health/stamina) and [Recoveries](scc.v1:mcdm.heroes.v1/rule.health/recoveries) that determine your physical hardiness. A class also provides your character with skills, several abilities—the unique features that define what your hero can do—and other features and benefits. You can be a [censor](scc.v1:mcdm.heroes.v1/class/censor), [conduit](scc.v1:mcdm.heroes.v1/class/conduit), [elementalist](scc.v1:mcdm.heroes.v1/class/elementalist), [fury](scc.v1:mcdm.heroes.v1/class/fury), [null](scc.v1:mcdm.heroes.v1/class/null), [shadow](scc.v1:mcdm.heroes.v1/class/shadow), [tactician](scc.v1:mcdm.heroes.v1/class/tactician), [talent](scc.v1:mcdm.heroes.v1/class/talent), or [troubadour](scc.v1:mcdm.heroes.v1/class/troubadour). See Chapter 5: [Classes](scc.v1:mcdm.heroes.v1/chapter/classes) for more information on each class, as well as the different types of abilities—[signature abilities](scc.v1:mcdm.heroes.v1/rule.combat/signature-ability), [heroic abilities](scc.v1:mcdm.heroes.v1/rule.general/heroic-ability), and more—that heroes of a specific class have access to.

#### 6. Kit

Your class might grant your hero a kit that helps define your approach to martial combat. The kit you choose provides you with equipment and a fighting style that grants a [signature ability](scc.v1:mcdm.heroes.v1/rule.combat/signature-ability), as well as [bonus](scc.v1:mcdm.heroes.v1/rule.dice/bonuses-and-penalties)es to one or more of your game statistics. See Chapter 6: [Kits](scc.v1:mcdm.heroes.v1/chapter/kits) for more information.

#### 7. Add Free Strikes

A [free strike](scc.v1:mcdm.heroes.v1/feature.common.main-actions/free-strike) is a combat ability you can use when it's not your [turn](scc.v1:mcdm.heroes.v1/rule.combat/turn), representing the simplest and most basic weapon attack you can make. An enemy is foolish enough to walk away from you in [melee](scc.v1:mcdm.heroes.v1/rule.combat/melee)? [Free strike](scc.v1:mcdm.heroes.v1/feature.common.main-actions/free-strike)! Every hero has a [melee](scc.v1:mcdm.heroes.v1/rule.combat/melee) weapon free strike and a [ranged](scc.v1:mcdm.heroes.v1/rule.combat/ranged) weapon free strike. They're all the same—until modified by your kit or class—and it's up to you to decide what exactly your [free strikes](scc.v1:mcdm.heroes.v1/feature.common.main-actions/free-strike) are. A thrown dagger? A punch? The design is intended to let you use your imagination.

You can also make [free strikes](scc.v1:mcdm.heroes.v1/feature.common.main-actions/free-strike) on your turn to represent using weapons your hero isn't otherwise themed to use. A [wode elf](scc.v1:mcdm.heroes.v1/ancestry/wode-elf) master archer can stab a too-close enemy with a dagger as a [free strike](scc.v1:mcdm.heroes.v1/feature.common.main-actions/free-strike), and a greataxe-wielding [orc](scc.v1:mcdm.heroes.v1/ancestry/orc) [fury](scc.v1:mcdm.heroes.v1/class/fury) can use a [free strike](scc.v1:mcdm.heroes.v1/feature.common.main-actions/free-strike) to hurl a handaxe at a flying enemy staying annoyingly out of [melee](scc.v1:mcdm.heroes.v1/rule.combat/melee) range.

See [Free Strikes](scc.v1:mcdm.heroes.v1/feature.common.main-actions/free-strike) in Chapter 10: [Combat](scc.v1:mcdm.heroes.v1/chapter/combat) for more information on using [free strikes](scc.v1:mcdm.heroes.v1/feature.common.main-actions/free-strike), and see Abilities in Chapter 5: [Classes](scc.v1:mcdm.heroes.v1/chapter/classes) for information on the ability format and how to read it.

#### 8. Complication

Complications represent those dramatic moments in a character's backstory that give them pathos, a dramatic reason to be an outsider, doubts about the meaning of life, an urge to avoid intimacy, or an unstoppable vendetta against an enemy from the past. Each complica tion grants a benefit and a drawback that make a character more three dimensional, but complications aren't necessary for making a great hero. Check with your Director as to whether your game is using them, and see Chapter 8: [Complications](scc.v1:mcdm.heroes.v1/chapter/complications) for more information.
...
- Another hero creates food, music, clothing, [trinkets](scc.v1:mcdm.heroes.v1/rule.treasure/trinket), or something else that you enjoy. Who is that hero, and what do they make?
...
If you're changing an option for some reason other than fun, you need to follow the usual rules for changing that option. For example, you might want to swap a kit out because you think the next adventure is going to require you to have better [distance](scc.v1:mcdm.heroes.v1/rule.combat/distance) with weapon [strikes](scc.v1:mcdm.heroes.v1/rule.combat/strike), doing so during a [respite](scc.v1:mcdm.heroes.v1/rule.resource/respite) as talked about in Chapter 6: [Kits](scc.v1:mcdm.heroes.v1/chapter/kits). If no rule for swapping out an option exists, such as wanting to change a [signature ability](scc.v1:mcdm.heroes.v1/rule.combat/signature-ability) granted by your class because you think a different [damage type](scc.v1:mcdm.heroes.v1/rule.damage/damage-type) would be more helpful against undead in an upcoming encounter, talk to your Director.

#### Optional Rule: Respite Ability Changes

An optional rule the Director can include in your game is to allow heroes to change any number of signature and [heroic abilities](scc.v1:mcdm.heroes.v1/rule.general/heroic-ability) granted by their class as a [respite](scc.v1:mcdm.heroes.v1/rule.resource/respite) activity (see [Respite](scc.v1:mcdm.heroes.v1/rule.resource/respite) in Chapter 1: [The Basics](scc.v1:mcdm.heroes.v1/chapter/the-basics)). This allows heroes to prepare for upcoming encounters and try new builds, but the Director and the players should all be comfortable with constantly juggling and learning new abilities.

### Heroic Advancement

Your character's heroic advancement is marked by level. Each time you gain a new level in your class, your [Stamina](scc.v1:mcdm.heroes.v1/rule.health/stamina) increases, and you gain new features or abilities according to your class's advancement, as detailed in Chapter 5: [Classes](scc.v1:mcdm.heroes.v1/chapter/classes).

In the standard setup for the game, heroes gain [Experience](scc.v1:mcdm.heroes.v1/rule.resource/experience) each time they finish a [respite](scc.v1:mcdm.heroes.v1/rule.resource/respite) (see Building a Heroic Narrative in Chapter 1: [The Basics](scc.v1:mcdm.heroes.v1/chapter/the-basics)). When you gain sufficient [Experience](scc.v1:mcdm.heroes.v1/rule.resource/experience), you gain a level during the same [respite](scc.v1:mcdm.heroes.v1/rule.resource/respite). The Heroic Advancement table shows exactly how much [Experience](scc.v1:mcdm.heroes.v1/rule.resource/experience) ([XP](scc.v1:mcdm.heroes.v1/rule.resource/experience)) you need to advance from one level to the next. The amount of [Experience](scc.v1:mcdm.heroes.v1/rule.resource/experience) you gain is cumulative.
...
Some Directors prefer that heroes gain new levels faster or slower to suit the pace of their story. The Adjusted [XP](scc.v1:mcdm.heroes.v1/rule.resource/experience) Advancement table is set up for campaigns where heroes advance at double or half the usual pace. Directors can also create their own customized pace for [XP](scc.v1:mcdm.heroes.v1/rule.resource/experience)-based advancement.

##### Milestone Advancement

Rather than tracking [XP](scc.v1:mcdm.heroes.v1/rule.resource/experience), some games have the heroes advance in level when they achieve a particular story milestone. For example, when a party defeats the main villain of an adventure and foils their dastardly plot, each hero gains a level for achieving this [objective](scc.v1:mcdm.heroes.v1/rule.combat/objective), no matter how many obstacles they faced along the way.
...
Some games don't track [XP](scc.v1:mcdm.heroes.v1/rule.resource/experience) or goals at all. The heroes simply gain a level whenever the Director decides it's appropriate for the story.

###### Heroic Advancement Table

| Level              | [XP](scc.v1:mcdm.heroes.v1/rule.resource/experience)    | Level | [XP](scc.v1:mcdm.heroes.v1/rule.resource/experience)      |
|--------------------|-------|-------|---------|
| 1st                | 0-15  | 6th   | 80-95   |
...
| Level | [XP](scc.v1:mcdm.heroes.v1/rule.resource/experience) for Double [Speed](scc.v1:mcdm.heroes.v1/rule.character/speed) | [XP](scc.v1:mcdm.heroes.v1/rule.resource/experience) for Half [Speed](scc.v1:mcdm.heroes.v1/rule.character/speed) |
|-------|---------------------|-------------------|
| 1st   | 0-7                 | 0-31              |
| 2nd   | 8-15                | 32-63             |
| 3rd   | 16-23               | 64-95             |
