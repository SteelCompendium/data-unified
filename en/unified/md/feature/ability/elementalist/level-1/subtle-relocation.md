...
effects:
    ...
    - cost: Spend 1 Essence
      effect: You [teleport](scc.v1:mcdm.heroes.v1/movement/teleport) the target up to a number of squares equal to twice your [Reason](scc.v1:mcdm.heroes.v1/rule.character/reason) score instead.
...
| **Magic, [Ranged](scc.v1:mcdm.heroes.v1/rule.combat/ranged), Void**  |           **[Triggered](scc.v1:mcdm.heroes.v1/rule.combat/triggered-action)** |
|--------------------------|------------------------:|
