...
| **Area, Earth, Magic** |               **[Main action](scc.v1:mcdm.heroes.v1/rule.combat/turn)** |
|------------------------|------------------------------:|
...
- **≤11:** M < WEAK[, prone](scc.v1:mcdm.heroes.v1/condition/prone)
- **12-16:** M < AVERAGE[, prone](scc.v1:mcdm.heroes.v1/condition/prone)
- **17+:** M < STRONG[, prone](scc.v1:mcdm.heroes.v1/condition/prone)
