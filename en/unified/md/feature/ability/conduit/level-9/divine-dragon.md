...
Additionally, you can use a maneuver to move the dragon up to their [speed](scc.v1:mcdm.heroes.v1/rule.character/speed), or to make a [melee](scc.v1:mcdm.heroes.v1/rule.combat/melee) weapon [strike](scc.v1:mcdm.heroes.v1/rule.combat/strike) with their claw against an [adjacent](scc.v1:mcdm.heroes.v1/rule.combat/adjacent) creature or object. The dragon can also make this [strike](scc.v1:mcdm.heroes.v1/rule.combat/strike) as a [free strike](scc.v1:mcdm.heroes.v1/feature.common.main-actions/free-strike).
