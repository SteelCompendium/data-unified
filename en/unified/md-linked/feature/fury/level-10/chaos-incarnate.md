...
Additionally, when you use [Primordial Strike](../level-4/primordial-strike.md), you can spend up to 3 ferocity, gaining 1 [surge](../../../rule/resource/surge.md) per ferocity spent to use for that [strike](../../../rule/combat/strike.md).
