...
## Summoner {data-scc="mcdm.summoner.v1/class/summoner"}
...
The [summoner](../class/summoner.md) is an example of a master class in Draw Steel. Master classes are intended for players who are familiar with the game and have played a few sessions already. They are not recommended for first time players—you need to know the rules before we start breaking them on you!
...
As a [summoner](../class/summoner.md), you gain the following features.
...
You also have special minions at your disposal called signature minions, low-cost creatures that you've become accustomed to summoning often. See [Portfolio](../feature/summoner/level-1/portfolio.md) for more details about the types of minions you can summon.
...
**Actions:** Minions in a squad act together on your [turn](../rule/combat/turn.md) in any order, before, in-between, and/or after any of your actions. They can either take a move action and a [main action](../rule/combat/turn.md) (excluding [Heal](../feature/common/main-actions/heal.md) and [Defend](../feature/common/main-actions/defend.md)), a move action and a [maneuver](../rule/combat/turn.md), or two move actions. Individual minions can also make [opportunity attacks](../rule/combat/opportunity-attack.md).

**[Free Strikes](../feature/common/main-actions/free-strike.md):** Unless otherwise specified, a minion's [free strike](../feature/common/main-actions/free-strike.md) has a distance of Melee 1 or Ranged 5 and deals the damage value listed on the stat block. The minion can choose to deal untyped damage or the [damage type](../rule/damage/damage-type.md) next to the damage value.

**[Damage](../rule/damage/damage.md):** Whenever multiple minions [strike](../rule/combat/strike.md) the same target simultaneously, the damage is added together and treated as a single strike. Minions in a squad targeting the same target with a [signature ability](../rule/combat/signature-ability.md) only apply one instance of the signature ability while each additional minion increases the damage by a number equal to their [free strike](../feature/common/main-actions/free-strike.md) value.
...
### Essence {data-scc="mcdm.summoner.v1/feature.summoner.level-1/essence"}
...
### Summoner Strike {data-scc="mcdm.summoner.v1/feature.summoner.level-1/summoner-strike"}

You have the following ability, which replaces both your melee and ranged [free strikes](../feature/common/main-actions/free-strike.md).

#### Summoner Strike {data-scc="mcdm.summoner.v1/feature.ability.summoner.level-1/summoner-strike"}
...
**Special:** This ability has the Charge keyword when it's used as a melee [strike](../rule/combat/strike.md).

### Strike For Me {data-scc="mcdm.summoner.v1/feature.summoner.level-1/strike-for-me"}

You have the following free [triggered action](../rule/combat/triggered-action.md).

#### Strike for Me {data-scc="mcdm.summoner.v1/feature.ability.summoner.level-1/strike-for-me"}
...
**Trigger:** You use a [triggered action](../rule/combat/triggered-action.md) to make a [free strike](../feature/common/main-actions/free-strike.md) or use a [signature ability](../rule/combat/signature-ability.md).

**Power Roll + [Reason](../rule/character/reason.md):**

- **≤11:** Up to three targets each make a [free strike](../feature/common/main-actions/free-strike.md)
- **12-16:** Up to five targets each make a [free strike](../feature/common/main-actions/free-strike.md)
- **17+:** Up to seven targets each make a [free strike](../feature/common/main-actions/free-strike.md)

**Special:** On a [natural 19 or 20](../rule/dice/natural-19-20.md), each target makes a [free strike](../feature/common/main-actions/free-strike.md).

**Effect:** Your minions act in place of you making a [free strike](../feature/common/main-actions/free-strike.md) or using a [signature ability](../rule/combat/signature-ability.md). If you were granted the [triggered action](../rule/combat/triggered-action.md) against a specific target, your minions must strike the same target. If the [triggered action](../rule/combat/triggered-action.md) granted you a [signature ability](../rule/combat/signature-ability.md), you have an [edge](../rule/dice/edge.md) on the [power roll](../rule/dice/power-roll.md).

**Your Minions Deal the Damage**

By normal Draw Steel rules, everyone gets access to [free strikes](../feature/common/main-actions/free-strike.md). As a [summoner](../class/summoner.md), you have a [free strike](../feature/common/main-actions/free-strike.md) equivalent in addition to minions who have their own free strikes. Changing how you attack allows your minions to shine in battle while keeping your damage output in line with your fellow heroes. The static damage you and most of your minions deal also keeps your [turns](../rule/combat/turn.md) fast and flowing.

### Call Forth {data-scc="mcdm.summoner.v1/feature.summoner.level-1/call-forth"}

You have the following ability.

#### Call Forth (1+ Essence) {data-scc="mcdm.summoner.v1/feature.ability.summoner.level-1/call-forth"}
...
### Minion Bridge {data-scc="mcdm.summoner.v1/feature.summoner.level-1/minion-bridge"}

You have the following maneuver.

#### Minion Bridge {data-scc="mcdm.summoner.v1/feature.ability.summoner.level-1/minion-bridge"}
...
**1 Essence:** An adjacent ally can [shift](../movement/shifting.md) alongside you during this movement. They must end their movement in an unoccupied square adjacent to the last minion you moved through.

### 1st-Level Circle Features {data-scc="mcdm.summoner.v1/feature.summoner.level-1/1st-level-circle-features"}
...
When you finish a [respite](../rule/resource/respite.md), you can always perceive the soul trails of each creature that took the [respite](../rule/resource/respite.md) with you until your next [respite](../rule/resource/respite.md).

### Formation {data-scc="mcdm.summoner.v1/feature.summoner.level-1/formation"}

You've practiced a specific formation for your minions. Choose one of the following formations: horde, platoon, elite, or leader. You can change your formation along with your quick command (see [Quick Command](../feature/summoner/level-1/quick-command.md)) by performing intense study as a [respite](../rule/resource/respite.md) activity. (*Quick Build:* [Platoon Formation](../feature/summoner/level-1/platoon-formation.md).)
...
Whenever one of your squads uses a damaging ability, choose one target of that ability to take additional [damage](../rule/damage/damage.md) equal to your [Reason](../rule/character/reason.md) score.

#### Elite Formation {data-scc="mcdm.summoner.v1/feature.summoner.level-1/elite-formation"}

Each of your minions have their [Stamina](../rule/health/stamina.md) increased by 3 and their [stability](../rule/character/stability.md) increased by 1.

#### Leader Formation {data-scc="mcdm.summoner.v1/feature.summoner.level-1/leader-formation"}
...
>
> - Treasures that give you a [damage](../rule/damage/damage.md) bonus to [rolled damage](../rule/damage/rolled-damage.md) only apply to [power rolls](../rule/dice/power-roll.md) made from a non-minion's space. However, when you use [Strike for Me](../feature/ability/summoner/level-1/strike-for-me.md), any bonus damage is applied to each enemy and object that took damage.
> - Once you reach level 4 as a [summoner](../class/summoner.md), you regain access to your normal [free strike](../feature/common/main-actions/free-strike.md) abilities while wielding a weapon treasure, an [implement](../rule/treasure/implement.md) treasure, or any treasure that enables you to make a [free strike](../feature/common/main-actions/free-strike.md) as a part of its effect.
...
### Quick Command {data-scc="mcdm.summoner.v1/feature.summoner.level-1/quick-command"}

You have a special command you can issue to your minions. Choose one of the following quick commands. You can change your quick command along with your formation (see [Formation](../feature/summoner/level-1/formation.md)) by performing intense study as a [respite](../rule/resource/respite.md) activity. (*Quick Build:* [Shield!](../feature/ability/summoner/level-1/shield.md))
...
### Portfolio {data-scc="mcdm.summoner.v1/feature.summoner.level-1/portfolio"}
...
### Summoner Abilities {data-scc="mcdm.summoner.v1/feature.summoner.level-1/summoner-abilities"}

Your own abilities focus on support and enable you to position and outfit your allies for success.

#### Heroic Abilities

Breaking down your [essence](../feature/summoner/level-1/essence.md) into pure power can lead to devastating effects. Your [heroic abilities](../rule/general/heroic-ability.md) enable you to punctuate your army's efforts.
...
**Effect:** Until the end of the encounter or until you are [dying](../rule/health/dying.md), each [minion](../feature/summoner/level-1/minions.md) under your control during the encounter is the target of the following effect:
...
Your circle allows you to call forth a piece of your [portfolio's](../feature/summoner/level-1/portfolio.md) dominion like any [minion](../feature/summoner/level-1/minions.md).

Once per encounter, you can use a maneuver to summon a fixture from your [minions'](../feature/summoner/level-1/minions.md) native manifold or origin into an unoccupied space on the ground within your Summoner's Range. You can spend 1 [essence](../feature/summoner/level-1/essence.md) to relocate the fixture as a [free maneuver](../rule/combat/free-maneuver.md) on your [turn](../rule/combat/turn.md). The fixture stays until the end of the encounter, until its [Stamina](../rule/health/stamina.md) is reduced to 0, or until you become [dying](../rule/health/dying.md).
...
> ⭐️ **Hunger Thrush**
>
> Each enemy that starts their [turn](../rule/combat/turn.md) within 3 squares of the boil is I < AVERAGE [taunted](../condition/taunted.md) (EoT) by the boil, or I < WEAK [taunted](../condition/taunted.md) (EoT) by the boil and can't move further from it.

> ⭐️ **Oh, It Pops**
>
> When the boil is destroyed, each enemy within 3 squares of the boil takes acid [damage](../rule/damage/damage.md) equal to your level and is A < STRONG [weakened](../condition/weakened.md) (save ends).
...
> ⭐️ **Fester Field**
>
> Each non-abyssal enemy that starts their [turn](../rule/combat/turn.md) within 3 squares of the boil takes 5 corruption [damage](../rule/damage/damage.md).
...
> ⭐️ **Bubbling Boost**
>
> You and each non-minion ally that enters one or more squares within 3 squares of the pond or starts their [turn](../rule/combat/turn.md) there has their [speed](../rule/character/speed.md) increased by 2 until the end of their [turn](../rule/combat/turn.md).

> ⭐️ **Overgrowth**
>
> Each of your fey [minions](../feature/summoner/level-1/minions.md) that ends their [turn](../rule/combat/turn.md) within 3 squares of the pond is hidden until the start of their next [turn](../rule/combat/turn.md).
...
> ⭐️ **Garden of Jest**
>
> You can spend a [Recovery](../rule/health/recoveries.md) the first time in a [round](../rule/combat/combat-round.md) a creature gains or starts their [turn](../rule/combat/turn.md) with a [condition](../rule/combat/condition.md) while you have [line of effect](../rule/combat/line-of-effect.md) to the pond. Alternatively, you can choose to enable an ally who also has [line of effect](../rule/combat/line-of-effect.md) to the boil to spend a [Recovery](../rule/health/recoveries.md) instead.
...
> ⭐️ **The Bell Tolls**
>
> Each enemy that starts their [turn](../rule/combat/turn.md) within 3 squares of the gates is I < AVERAGE [frightened](../condition/frightened.md) (EoT) by the gates. The [potency](../rule/character/potency.md) increases by 1 for [winded](../rule/health/winded.md) enemies.

> ⭐️ **Undead Dominion**
>
> Each of your undead [minions](../feature/summoner/level-1/minions.md) has [damage immunity](../rule/damage/damage-immunity.md) 2 while occupying a space within 3 squares of the gates.
...
> ⭐️ **Memento Mori**
>
> You gain a [surge](../rule/resource/surge.md) the first time in a [round](../rule/combat/combat-round.md) one of your undead [minions](../feature/summoner/level-1/minions.md) unwillingly dies while you have [line of effect](../rule/combat/line-of-effect.md) to the gates. You can choose to give the [surge](../rule/resource/surge.md) to an ally who also has [line of effect](../rule/combat/line-of-effect.md) to the gates.
...
> ⭐️ **Open the Gates**
>
> You can use [Rise!](../feature/summoner/level-1/rise.md) as a [free triggered action](../rule/combat/triggered-action.md) each time an enemy dies within 3 squares of the gates while you have [line of effect](../rule/combat/line-of-effect.md) to the gates.

#### New Portfolio Minion {data-scc="mcdm.summoner.v1/feature.summoner.level-2/new-portfolio-minion"}

Your circle allows you to select new [minions](../feature/summoner/level-1/minions.md) to add to your [portfolio](../feature/summoner/level-1/portfolio.md).
...
As a 3rd-level [summoner](../class/summoner.md), you gain the following features.

#### Summoner's Kit {data-scc="mcdm.summoner.v1/feature.summoner.level-3/summoners-kit"}

You conjure a kit for yourself. This kit includes an [implement](../rule/treasure/implement.md), such as a rod or a baton, which grants you the following benefits:

- The [damage](../rule/damage/damage.md) of your [Summoner Strike](../feature/ability/summoner/level-1/summoner-strike.md) ability increases to twice your [Reason](../rule/character/reason.md) score.
- The [potency](../rule/character/potency.md) of your [Summoner Strike](../feature/ability/summoner/level-1/summoner-strike.md) ability increases to R < AVERAGE.
- The distance of your [Summoner Strike](../feature/ability/summoner/level-1/summoner-strike.md) ability is now equal to your Summoner's Range.

Your kit also comes with wards like magic armor and transient [minion](../feature/summoner/level-1/minions.md) forces. Choose one of the following wards.

##### Conjured Ward {data-scc="mcdm.summoner.v1/feature.summoner.level-3/conjured-ward"}

You are clad in the natural defenses of your [portfolio](../feature/summoner/level-1/portfolio.md) (bones, fairy wood, stone, writhing flesh). You gain a +3 bonus to [Stamina](../rule/health/stamina.md) and that bonus increases by 3 at 4th, 7th, and 10th levels.

##### Emergency Ward {data-scc="mcdm.summoner.v1/feature.summoner.level-3/emergency-ward"}

The first time each [round](../rule/combat/combat-round.md) you take [damage](../rule/damage/damage.md), you can use a [free triggered action](../rule/combat/triggered-action.md) to [shift](../movement/shifting.md) 1 after the triggering effect resolves and summon a signature [minion](../feature/summoner/level-1/minions.md) into the square you left (as long as there is enough space).

##### Howling Ward {data-scc="mcdm.summoner.v1/feature.summoner.level-3/howling-ward"}

You create a 1-[aura](../rule/combat/aura.md) vortex of slicing magic around you when you enter combat. An enemy that starts their [turn](../rule/combat/turn.md) [adjacent](../rule/combat/adjacent.md) to you takes [damage](../rule/damage/damage.md) equal to your [Reason](../rule/character/reason.md).

##### Snare Ward {data-scc="mcdm.summoner.v1/feature.summoner.level-3/snare-ward"}

Whenever an [adjacent](../rule/combat/adjacent.md) creature deals [damage](../rule/damage/damage.md) to you, you can use a [free triggered action](../rule/combat/triggered-action.md) to pull that creature toward one of your [minions](../feature/summoner/level-1/minions.md) within your Summoner's Range a number of squares equal to your [Reason](../rule/character/reason.md) score.
...
**Effect:** You summon a temporary squad containing 6 of your signature [minions](../feature/summoner/level-1/minions.md) regardless of your minion maximum within distance. Whenever one of these [minions](../feature/summoner/level-1/minions.md) deals [damage](../rule/damage/damage.md) to an enemy, the enemy is R < AVERAGE compelled to move 5 squares toward the source of the [damage](../rule/damage/damage.md) (provoking [opportunity attacks](../rule/combat/opportunity-attack.md)). The [potency](../rule/character/potency.md) increases by 1 for enemies targeted by two or more of these [minions](../feature/summoner/level-1/minions.md).
...
- **≤11:** 5 [damage](../rule/damage/damage.md); [push](../movement/forced-movement.md) 2
- **12-16:** 9 [damage](../rule/damage/damage.md); [push](../movement/forced-movement.md) 4
- **17+:** 12 [damage](../rule/damage/damage.md); [push](../movement/forced-movement.md) 6
...
- **17+:** 16 + R [damage](../rule/damage/damage.md); R < STRONG [dazed](../condition/dazed.md) (save ends)

### 4th-Level Features

As a 4th-level [summoner](../class/summoner.md), you gain the following features.

#### Characteristic Increase {data-scc="mcdm.summoner.v1/feature.summoner.level-4/characteristic-increase"}

Your [Reason](../rule/character/reason.md) score becomes 3. Additionally, you can increase one of your [characteristic](../rule/character/characteristic.md) scores by 1, to a maximum score of 3.

#### Minion Improvement {data-scc="mcdm.summoner.v1/feature.summoner.level-4/minion-improvement"}

Your maximum number of [minions](../feature/summoner/level-1/minions.md) increases by 4.

You can increase each of your [minions'](../feature/summoner/level-1/minions.md) [Stamina](../rule/health/stamina.md) as shown on the 4th-Level Minion Stamina Increase table. Additionally, each [minion](../feature/summoner/level-1/minions.md) that receives a [Stamina](../rule/health/stamina.md) boost can treat their [characteristics](../rule/character/characteristic.md) as one higher for the purposes of resisting [potencies](../rule/character/potency.md) (to a maximum value of 3).

These benefits are not reflected in the stat blocks of new [minions](../feature/summoner/level-1/minions.md) you acquire.
...
The first time each [combat round](../rule/combat/combat-round.md) that any [minion](../feature/summoner/level-1/minions.md) unwillingly dies within your Summoner's Range, you gain 2 [essence](../feature/summoner/level-1/essence.md) instead of 1.

#### Minion Chain {data-scc="mcdm.summoner.v1/feature.summoner.level-4/minion-chain"}

Whenever you use [Minion Bridge](../feature/ability/summoner/level-1/minion-bridge.md) as a maneuver, each of your [minions](../feature/summoner/level-1/minions.md) within your Summoner's Range can [shift](../movement/shifting.md) up to their [speed](../rule/character/speed.md) before the maneuver takes effect, as long as each [minion](../feature/summoner/level-1/minions.md) that [shifts](../movement/shifting.md) ends their movement [adjacent](../rule/combat/adjacent.md) to another one of your [minions](../feature/summoner/level-1/minions.md).

Additionally, your [minions](../feature/summoner/level-1/minions.md) can chain themselves together to function as a ladder or a swinging rope. When your [minions](../feature/summoner/level-1/minions.md) move as a part of using [Minion Bridge](../feature/ability/summoner/level-1/minion-bridge.md), each [minion](../feature/summoner/level-1/minions.md) can use this movement to [shift](../movement/shifting.md) into a position directly beneath another one of your [minions](../feature/summoner/level-1/minions.md), hoisting them and each other [minion](../feature/summoner/level-1/minions.md) they have hoisted, until they form a chain. The chain can then choose to fall across an unoccupied space and/or the topmost [minion](../feature/summoner/level-1/minions.md) [grabs](../feature/common/maneuvers/grab.md) an object to keep the chain steady.

The chain lasts until the start of your next [turn](../rule/combat/turn.md) or until the chain is no longer steady. The chain can also end when a [minion](../feature/summoner/level-1/minions.md) in the chain is destroyed or when you command your [minions](../feature/summoner/level-1/minions.md) to let go as a [free maneuver](../rule/combat/free-maneuver.md). All [size](../rule/character/size.md) 1 [minions](../feature/summoner/level-1/minions.md) count as one square when determining the chain's length.

#### Perk {data-scc="mcdm.summoner.v1/feature.summoner.level-4/perk"}

You gain any one [perk](../feature/summoner/level-4/perk.md) of your choice. See Perks in Draw Steel: Heroes for more information.
...
As a 5th-level [summoner](../class/summoner.md), you gain the following features.
...
You can attempt to stop channeling the spirit at any time. If the spirit is hostile to you or you've hosted them for at least 1 hour, you must make a medium [Presence](../rule/character/presence.md) [test](../rule/test/test.md). On success, the spirit leaves your body. On failure, you become fully possessed by a haunt; you have no access to your skills and you can't get above a tier 2 result on [power rolls](../rule/dice/power-roll.md) until you exorcise the haunt either by completing the [Find a Cure](../project/find-a-cure.md) downtime project in Draw Steel: Heroes or taking a [respite](../rule/resource/respite.md) with an exorcist.
...
Additionally, whenever one of your demon [minions](../feature/summoner/level-1/minions.md) Death Snaps, their target is P < WEAK affected by a [condition](../rule/combat/condition.md) the [minion](../feature/summoner/level-1/minions.md) was suffering from. The [potency](../rule/character/potency.md) increases by 1 on each subsequent Death Snap the target takes [damage](../rule/damage/damage.md) from in the same [turn](../rule/combat/turn.md) (maximum +2).
...
As a 6th-level [summoner](../class/summoner.md), you gain the following features.
...
At the end of the [respite](../rule/resource/respite.md), you and everyone you brought with you immediately teleports back into the same location from which you made the portal.

#### Minion Machinations {data-scc="mcdm.summoner.v1/feature.summoner.level-6/minion-machinations"}

Your maximum number of [followers](../rule/general/follower.md) increases by 2.
...
Additionally, whenever you reduce an enemy to 0 [Stamina](../rule/health/stamina.md) with your [Summoner Strike](../feature/ability/summoner/level-1/summoner-strike.md) ability, you can use [Call Forth](../feature/ability/summoner/level-1/call-forth.md) as a [free maneuver](../rule/combat/free-maneuver.md). Minions summoned this way are unable to act during this [turn](../rule/combat/turn.md).
...
Until the end of the encounter or you become [dying](../rule/health/dying.md), each target has a +2 [bonus](../rule/dice/bonuses-and-penalties.md) to [saving throws](../rule/general/saving-throw.md).
...
- **≤11:** 5 [damage](../rule/damage/damage.md); M < WEAK [prone](../condition/prone.md) and can't stand ([save ends](../rule/general/saving-throw.md))
- **12-16:** 8 [damage](../rule/damage/damage.md); M < AVERAGE [prone](../condition/prone.md) and can't stand ([save ends](../rule/general/saving-throw.md))
- **17+:** 11 [damage](../rule/damage/damage.md); M < STRONG [prone](../condition/prone.md) and can't stand ([save ends](../rule/general/saving-throw.md))
...
As a 7th-level [summoner](../class/summoner.md), you gain the following features.

#### Characteristic Increase {data-scc="mcdm.summoner.v1/feature.summoner.level-7/characteristic-increase"}

All of your [characteristics](../rule/character/characteristic.md) increase by 1, to a maximum score of 4.
...
If you or an ally within your Summoner's Range would [die](../rule/health/dying.md) from an effect that isn't age related, you sacrifice all your active minions (minimum 1) and spend all your essence (minimum 1) as a [free triggered action](../rule/combat/triggered-action.md) to bring the target back to life, reconstructing the damaged parts of their body with summoned material related to your portfolio. The target comes back with 0 [Stamina](../rule/health/stamina.md) plus 1 [Stamina](../rule/health/stamina.md) for each minion and essence used in the effect. You must have at least one fragment of the creature's remains, and the creature's soul must be willing to return to life for the effect to work.

You can't use this feature again until you gain a new level, or until you spend 3 eidos to use it (see [Eidos](../feature/summoner/level-10/eidos.md)).
...
As an 8th-level [summoner](../class/summoner.md), you gain the following features.

#### Perk {data-scc="mcdm.summoner.v1/feature.summoner.level-8/perk"}

You gain any one perk of your choice. See Perks in Draw Steel: Heroes for more information.

#### 8th-Level Circle Feature {data-scc="mcdm.summoner.v1/feature.summoner.level-8/8th-level-circle-feature"}
...
- Your champion can take the [Heal](../feature/common/main-actions/heal.md) and [Defend](../feature/common/main-actions/defend.md) Actions.
...
Your champion gains additional features at 10th level. This includes a special Champion Action ability that costs eidos to use (see [Eidos](../feature/summoner/level-10/eidos.md)). This ability can be activated once per encounter at the end of any other creature's [turn](../rule/combat/turn.md).
...
>
> 9 affinity [damage](../rule/damage/damage.md); [push](../movement/forced-movement.md) 2
>
> 12 affinity [damage](../rule/damage/damage.md); [push](../movement/forced-movement.md) 4
>
> 14 affinity [damage](../rule/damage/damage.md); [push](../movement/forced-movement.md) 6
...
> ⭐️ **Champion's Ire**
>
> If the Portent only targets one creature or object with a [strike](../rule/combat/strike.md), they deal additional [damage](../rule/damage/damage.md) to the target equal to your [Reason](../rule/character/reason.md).

> ⭐️ **Searing Wyrmscale**
>
> Whenever an [adjacent](../rule/combat/adjacent.md) creature deals [damage](../rule/damage/damage.md) to the Portent, they take 4 affinity [damage](../rule/damage/damage.md).
...
As a 9th-level [summoner](../class/summoner.md), you gain the following features.
...
- The [potency](../rule/character/potency.md) of your [Summoner Strike](../feature/ability/summoner/level-1/summoner-strike.md) ability increases to R < STRONG.
- You can choose one additional ward from your [Summoner's Kit](../feature/summoner/level-3/summoners-kit.md).
- You have a double [edge](../rule/dice/edge.md) on [tests](../rule/test/test.md) made to dissuade or scare enemy minions or lackeys.
...
You and your allies are now welcome in your circle's source manifold. Negotiations with native denizens of your circle's source manifold have their [patience](../rule/negotiation/patience.md) increased by 2.
...
- **≤11:** 6 [damage](../rule/damage/damage.md); [push](../movement/forced-movement.md) 4 M < WEAK push is vertical
- **12-16:** 10 [damage](../rule/damage/damage.md); [push](../movement/forced-movement.md) 5 M < AVERAGE push is vertical
- **17+:** 14 [damage](../rule/damage/damage.md); [push](../movement/forced-movement.md) 6 M < STRONG push is vertical

**Effect:** You can use this ability as if in the space of one of your minions within your Summoner's Range.

You can change the [damage type](../rule/damage/damage-type.md) to be a type that your champion deals on their stat block (see [Portfolio Champion](../feature/summoner/level-8/portfolio-champion.md)). For each enemy reduced to 0 [Stamina](../rule/health/stamina.md) by this ability, an ally within [distance](../rule/combat/distance.md) can move up to their [speed](../rule/character/speed.md).

### 10th-Level Features

As a 10th-level [summoner](../class/summoner.md), you gain the following features.

#### Characteristic Increase {data-scc="mcdm.summoner.v1/feature.summoner.level-10/characteristic-increase"}

Your [Reason](../rule/character/reason.md) score becomes 5. Additionally, you can increase one of your [characteristic](../rule/character/characteristic.md) scores by 1, to a maximum score of 5.
...
You and your champion also have access to abilities that can be used by spending eidos (see [Their Life for Mine](../feature/summoner/level-7/their-life-for-mine.md) and [Portfolio Champion](../feature/summoner/level-8/portfolio-champion.md)).
...
Whenever you sacrifice minions, you now reduce the cost of a [heroic ability](../rule/general/heroic-ability.md) or minion by the same amount (to a minimum of 1) instead of only reducing the cost by 1.

#### Among Our Ranks {data-scc="mcdm.summoner.v1/feature.summoner.level-10/among-our-ranks"}

As a [respite](../rule/resource/respite.md) activity, you summon a willing and not-[restrained](../condition/restrained.md) [NPC](../rule/general/npc.md) or player ally to join your party, regardless of [distance](../rule/combat/distance.md) or manifold. The target stays until the start of your next [respite](../rule/resource/respite.md) or until they are killed, in which they are immediately dismissed to the place from which they were summoned. You can't have more than one character summoned in this way.
