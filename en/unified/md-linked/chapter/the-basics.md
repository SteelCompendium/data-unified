...
The game uses two types of power rolls. An **[ability roll](../rule/dice/ability-roll.md)** is used when you use certain abilities to determine their impact. For instance, if a [fury](../class/fury.md) uses their [Brutal Slam](../feature/ability/fury/level-1/brutal-slam.md) ability to strike an enemy, their [ability roll](../rule/dice/ability-roll.md) determines how much [damage](../rule/damage/damage.md) the enemy takes and how far back the enemy is [pushed](../movement/forced-movement.md). See Abilities for more information.
