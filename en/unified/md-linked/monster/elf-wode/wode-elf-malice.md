...
features:
    - body: Each wode elf who ends this turn hidden can [shift](../../movement/shifting.md) up to their speed while remaining hidden.
      cost: 3 Malice
      effects:
        - effect: Each wode elf who ends this turn hidden can [shift](../../movement/shifting.md) up to their speed while remaining hidden.
      icon: ⭐️
      name: Forest Network
    ...
    - cost: 7 Malice
      effects:
        - effect: Vines rapidly grow across the entire encounter map. Each enemy in the encounter makes an **Agility test**.
          tier1: 8 damage; [restrained](../../condition/restrained.md) (save ends)
