...
features:
    - body: One devil acting this turn uses a [signature ability](../../rule/combat/signature-ability.md) against an [adjacent](../../rule/combat/adjacent.md) creature. On a tier 3 outcome, the target of the ability has a double [bane](../../rule/dice/bane.md) on strikes (save ends).
      cost: 3 Malice
      effects:
        - effect: One devil acting this turn uses a [signature ability](../../rule/combat/signature-ability.md) against an [adjacent](../../rule/combat/adjacent.md) creature. On a tier 3 outcome, the target of the ability has a double [bane](../../rule/dice/bane.md) on strikes (save ends).
      icon: "\U0001F464"
    ...
    - body: Each enemy in the encounter is subject to a bad deal proposed by the [devils](../group/devil.md). An enemy must choose between having damage weakness 5 or taking a [bane](../../rule/dice/bane.md) on power rolls. The bad deal lasts until the end of the encounter.
      cost: 7 Malice
      effects:
        - effect: Each enemy in the encounter is subject to a bad deal proposed by the [devils](../group/devil.md). An enemy must choose between having damage weakness 5 or taking a [bane](../../rule/dice/bane.md) on power rolls. The bad deal lasts until the end of the encounter.
      icon: "\U0001F300"
...
>
> Each enemy in the encounter is subject to a bad deal proposed by the [devils](../group/devil.md). An enemy must choose between having damage weakness 5 or taking a [bane](../../rule/dice/bane.md) on power rolls. The bad deal lasts until the end of the encounter.
