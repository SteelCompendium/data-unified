...
features:
    ...
    - effects:
        - effect: Only a creature attuned to the throne can sit on it. A creature [adjacent](scc.v1:mcdm.heroes.v1/rule.combat/adjacent) to the throne can use a main action to attune to it by succeeding on a **Presence test**.
    ...
    - distance: Ranged 10
      effects:
        - effect: A target within distance is made [winded](scc.v1:mcdm.heroes.v1/rule.health/winded) or is reduced to 0 [Stamina](scc.v1:mcdm.heroes.v1/rule.health/stamina) by fire damage.
          name: Trigger
