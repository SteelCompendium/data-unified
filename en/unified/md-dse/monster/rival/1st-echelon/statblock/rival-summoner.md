...
features:
    - effects:
        - effect: The summoner can command up to two squads of minions with a maximum of 4 minions per squad. They can only have one squad of [signature minions](scc.v1:mcdm.summoner.v1/feature.summoner.level-1/minions) active at any time.
    ...
    - distance: Ranged 10
      effects:
        - effect: If one of the summoner's minions is [adjacent](scc.v1:mcdm.heroes.v1/rule.combat/adjacent) to the target and is within distance of the [strike](scc.v1:mcdm.heroes.v1/rule.combat/strike), they become the new target of the strike.
          name: Effect
        - cost: 2 Malice
          effect: Instead of commanding an existing minion, the summoner summons a **skeleton** into an unoccupied space [adjacent](scc.v1:mcdm.heroes.v1/rule.combat/adjacent) to the target to take the strike.
      feature_type: ability
      icon: ❗️
      keywords: []
      name: Corpse Shield
