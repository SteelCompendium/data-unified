...
spend: '1+ Drama: You can trigger this ability when a target uses an ability that has a [Heroic Resource](scc.v1:mcdm.heroes.v1/rule.resource/heroic-resource) cost of 3 + each additional drama spent.'
subtype: triggered
target: One ally
...
effects:
    - effect: The target can choose one additional target for the triggering ability. Any damage dealt to the additional target is sonic damage.
    - effect: '1+ Drama: You can trigger this ability when a target uses an ability that has a [Heroic Resource](scc.v1:mcdm.heroes.v1/rule.resource/heroic-resource) cost of 3 + each additional drama spent.'
      name: Spend
feature_type: ability
flavor: Give the chorus a little punch.
keywords:
