...
features:
    ...
    - body: The crystal is now size 3.
      effects:
        - effect: The crystal is now size 3.
      icon: ⭐️
      level: 9
      name: Size Increase
    - body: When you or an ally makes a ranged [strike](scc.v1:mcdm.heroes.v1/rule.combat/strike) that draws a line through the crystal, the user gains a [surge](scc.v1:mcdm.heroes.v1/rule.resource/surge) which they can use on the ability.
      effects:
        - effect: When you or an ally makes a ranged [strike](scc.v1:mcdm.heroes.v1/rule.combat/strike) that draws a line through the crystal, the user gains a [surge](scc.v1:mcdm.heroes.v1/rule.resource/surge) which they can use on the ability.
      icon: ⭐️
      level: 9
      name: Magnified Strike
file_basename: primordial-crystal
file_dpath: monster/fixture/elemental/advancement-features
item_id: primordial-crystal
item_name: Primordial Crystal Advancement Features
name: Primordial Crystal Advancement Features
scc: mcdm.summoner.v1/monster.fixture.elemental.advancement-features/primordial-crystal
