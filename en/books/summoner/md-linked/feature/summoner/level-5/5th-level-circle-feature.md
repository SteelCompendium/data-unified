...
Additionally, whenever one of your demon [minions](../level-1/minions.md) Death Snaps, their target is P < WEAK affected by a [condition](../../../rule/combat/condition.md) the [minion](../level-1/minions.md) was suffering from. The [potency](../../../rule/character/potency.md) increases by 1 on each subsequent Death Snap the target takes [damage](../../../rule/damage/damage.md) from in the same [turn](../../../rule/combat/turn.md) (maximum +2).
...
> ⭐️ **Gorrring Strike**
>
> The gorrre must [charge](../../common/main-actions/charge.md) before making a [strike](../../../rule/combat/strike.md). The target is M < STRONG knocked [prone](../../../condition/prone.md) if the gorrre moved through an enemy or object other than the target during the [charge](../../common/main-actions/charge.md).

> ⭐️ **Devastating Charge**
>
> The gorrre ignores [difficult terrain](../../../movement/difficult-terrain.md) while [charging](../../common/main-actions/charge.md) and destroys unattended, [size](../../../rule/character/size.md) 1 objects in their path. Each enemy they move through during a [charge](../../common/main-actions/charge.md) takes 3 [damage](../../../rule/damage/damage.md).
...
> ⭐️ **Use Their Might**
>
> When targeting a creature with a [grab](../../common/maneuvers/grab.md) or [forced movement](../../../movement/forced-movement.md), the olyender's [size](../../../rule/character/size.md) is considered one larger than the target.
...
> ⭐️ **Big Stomp**
>
> The titan's melee [free strikes](../../common/main-actions/free-strike.md) M < STRONG knock the target [prone](../../../condition/prone.md).
