...
features:
    - effects:
        - effect: The gale doesn't provoke [opportunity attacks](../../../../../rule/combat/opportunity-attack.md) by moving.
      feature_type: trait
      icon: ⭐️
      name: Cutting the Air
      type: feature
    - effects:
        - effect: When the gale is reduced to 0 [Stamina](../../../../../rule/health/stamina.md), winds whip in their space until the end of the encounter. You or an ally that enters this space or starts their turn there can immediately [shift](../../../../../movement/shifting.md) (including vertically).
      feature_type: trait
      icon: ⭐️
      name: Whirlwind
      type: feature
