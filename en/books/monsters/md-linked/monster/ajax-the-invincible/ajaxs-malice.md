...
features:
    ...
    - body: Until the end of the round, Ajax chooses one of the following environments he has previously visited and overlays that environment on top of the encounter map, temporarily merging multiple realities.
      ...
      effects:
        ...
        - effect: The winds whip and bluster. Any creature who can't [fly](../../movement/fly.md) takes a −3 penalty to stability, and [forced movement](../../movement/forced-movement.md) effects gain a +3 bonus to their distance against such creatures.
          name: Incredibly High Above the Ground
        - effect: The ground is [difficult terrain](../../movement/difficult-terrain.md) for enemies. Any creature who starts and ends their turn in the same space is [restrained](../../condition/restrained.md) (save ends).
          name: Swamp
    ...
    - body: Ajax takes an additional main action on his turn. He can use this feature even if he is [dazed](../../condition/dazed.md).
      cost: 5 Malice
      effects:
        - effect: Ajax takes an additional main action on his turn. He can use this feature even if he is [dazed](../../condition/dazed.md).
      icon: ☠️
      name: Solo Action
    - cost: 10 Malice
      ...
      effects:
        - effect: Each target makes a test using their highest characteristic.
          name: Effect
          tier1: 26 damage; [bleeding](../../condition/bleeding.md) and [slowed](../../condition/slowed.md) (save ends)
          tier2: 22 damage; [bleeding](../../condition/bleeding.md) (save ends)
          tier3: 16 damage
