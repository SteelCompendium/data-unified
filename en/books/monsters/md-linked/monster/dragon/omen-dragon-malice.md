...
features:
    - body: The dragon expands their wings to create a shroud of shadow. Until the start of the dragon's next turn, any strike made against them takes a [bane](../../rule/dice/bane.md).
      cost: 3 Malice
      effects:
        - effect: The dragon expands their wings to create a shroud of shadow. Until the start of the dragon's next turn, any strike made against them takes a [bane](../../rule/dice/bane.md).
      icon: ⭐️
      name: Black Skies
    - cost: 5 Malice
      effects:
        - effect: The dragon [flies](../../movement/fly.md) up to 10 squares and carries fated souls with them. Each creature in the area of the dragon's Stagnant Wyrmscale Aura [trait](../../rule/monster/monster-trait.md) makes a **Presence test**.
