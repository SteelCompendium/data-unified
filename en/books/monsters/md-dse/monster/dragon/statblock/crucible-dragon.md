...
features:
    ...
    - distance: Melee 3
      effects:
        - roll: Power Roll + 4
          ...
          tier2: 17 damage; M < 3 [prone](scc.v1:mcdm.heroes.v1/condition/prone)
          tier3: 20 damage; M < 4 [prone](scc.v1:mcdm.heroes.v1/condition/prone)
      feature_type: ability
      icon: "\U0001F5E1"
      keywords:
        - Melee
    ...
    - cost: 1 Malice
      distance: 2 burst
      effects:
        - effect: '**Effect:** The dragon expels blistering steam, dealing 7 fire damage to each target in the area. The dragon then [shifts](scc.v1:mcdm.heroes.v1/movement/shifting) up to their speed vertically and can [fly](scc.v1:mcdm.heroes.v1/movement/fly) until the end of the round.'
      feature_type: ability
      icon: ❇️
      keywords:
        - Area
    ...
    - cost: 1 Malice
      ...
      effects:
        - roll: Power Roll + 4
          tier1: Push 5
          tier2: Push 7
          tier3: Push 10, ignoring [stability](scc.v1:mcdm.heroes.v1/rule.character/stability)
      feature_type: ability
      icon: ❗️
      keywords:
        - Area
    ...
    - cost: Villain Action 1
      ...
      effects:
        - roll: Power Roll + 4
          tier1: 4 fire damage; I < 2 [frightened](scc.v1:mcdm.heroes.v1/condition/frightened) (save ends)
          tier2: 6 fire damage; I < 3 [frightened](scc.v1:mcdm.heroes.v1/condition/frightened) (save ends)
          tier3: 8 fire damage; I < 4 [frightened](scc.v1:mcdm.heroes.v1/condition/frightened) (save ends)
      feature_type: ability
      icon: ☠️
      keywords:
        - Area
