...
features:
    - cost: Encounter
      ...
      sections:
        - label: Effect
          text: The mercenary must be [winded](scc.v1:mcdm.heroes.v1/rule.health/winded) to use this ability. The mercenary uses Big Bite against each target.
...
item_name: Troll Mercenary Advancement Features
