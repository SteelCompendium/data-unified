...
features:
    ...
    - distance: 10 x 1 line within 10
      effects:
        - roll: Power Roll + 3
          ...
          tier2: 10 lightning damage; I < 2 [slowed](../../../condition/slowed.md) (save ends)
          tier3: 13 lightning damage; I < 3 [slowed](../../../condition/slowed.md) (save ends)
      feature_type: ability
      icon: "\U0001F533"
      keywords:
        - Area
    ...
    - effects:
        - effect: Whenever a non-[minion](../../../rule/organization/minion.md) voiceless talker within 5 squares of the artillerist uses a psionic ability, they can do so as if they were in the artillerist's space.
      feature_type: trait
      icon: ⭐️
