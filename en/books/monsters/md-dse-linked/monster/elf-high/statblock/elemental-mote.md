...
features:
    - ability_type: Signature Ability
      ...
      usage: Main action
    - effects:
        - effect: On their turn, the mote can leave the encounter in a flash of light to revive one [adjacent](../../../rule/combat/adjacent.md) dead soot crow, brambleguard, or ceramic horse. The revived creature returns with 3 Stamina.
      feature_type: trait
      icon: ⭐️
      name: Spark of Life
      type: feature
