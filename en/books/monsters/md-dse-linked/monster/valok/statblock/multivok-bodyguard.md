...
features:
    - ability_type: Signature Ability
      ...
      effects:
        - roll: Power Roll + 4
          tier1: 13 damage
          tier2: 18 damage
          tier3: 22 damage; A < 4 [bleeding](../../../condition/bleeding.md) (save ends)
    ...
    - cost: 3 Malice
      ...
      effects:
        - roll: Power Roll + 4
          ...
          tier3: 26 damage; [prone](../../../condition/prone.md); M < 4 [weakened](../../../condition/weakened.md) (save ends)
      feature_type: ability
      icon: "\U0001F5E1"
      keywords:
        - Melee
    ...
    - effects:
        - effect: At the start of the bodyguard's turn, each servok within 2 squares of them regains 15 [Stamina](../../../rule/health/stamina.md).
      feature_type: trait
      icon: ⭐️
    ...
    - effects:
      ...
      type: feature
    - effects:
        - effect: While the bodyguard isn't [bleeding](../../../condition/bleeding.md), [weakened](../../../condition/weakened.md), or [winded](../../../rule/health/winded.md), any power roll made against them is automatically a tier 1 outcome. A critical hit still grants its additional main action.
      feature_type: trait
      icon: ⭐️
      name: Valiar Might
      type: feature
