...
features:
    - ability_type: Signature Ability
      ...
      usage: Main action
    - effects:
        - effect: Whenever a non-[minion](../../../rule/organization/minion.md) ally within 5 squares of the mage mauler is reduced to 0 [Stamina](../../../rule/health/stamina.md), the mage mauler can move up to their speed.
      feature_type: trait
      icon: ⭐️
      name: Death Circle
      type: feature
