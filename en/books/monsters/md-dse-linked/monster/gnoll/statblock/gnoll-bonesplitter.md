...
features:
    ...
    - cost: 4 Malice
      ...
      usage: Maneuver
    - effects:
        - effect: Whenever a non-[minion](../../../rule/organization/minion.md) ally within 5 squares of the bonesplitter is reduced to 0 [Stamina](../../../rule/health/stamina.md), the bonesplitter moves up to their speed and can make a melee [free strike](../../../feature/common/main-actions/free-strike.md).
      feature_type: trait
      icon: ⭐️
      name: Death Frenzy
      type: feature
