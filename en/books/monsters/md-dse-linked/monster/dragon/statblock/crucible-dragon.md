    ...
    - ability_type: Signature Ability
      ...
      effects:
        - effect: Each target makes an Agility test.
          ...
          tier3: 6 fire damage
        - effect: A slagged target is coated in molten metal and takes 2d6 fire damage at the start of each of their turns. If a slagged target has M < 3 they are [restrained](../../../condition/restrained.md) (save ends) whenever they take cold damage.
