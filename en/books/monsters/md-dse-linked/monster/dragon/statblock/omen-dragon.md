...
features:
    ...
    - distance: Melee 4
      ...
      usage: Main action
    - effects:
        - effect: Once per turn, the dragon chooses one creature with a Deathcount within [line of effect](../../../rule/combat/line-of-effect.md). That creature can choose to take 1d6 damage and lose a [recovery](../../../rule/health/recoveries.md) to increase their Deathcount by 5.
      feature_type: trait
      icon: ⭐️
