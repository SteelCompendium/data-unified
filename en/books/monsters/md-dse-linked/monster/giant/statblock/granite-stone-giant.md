...
features:
    ...
    - effects:
      ...
      type: feature
    - effects:
        - effect: The granite stone giant ignores [difficult terrain](../../../movement/difficult-terrain.md).
      feature_type: trait
      icon: ⭐️
      name: Stone Steps
      type: feature
    - effects:
        - effect: The granite stone giant can [burrow](../../../movement/burrow.md) through stone, but can't drag other creatures underground when they do so.
      feature_type: trait
      icon: ⭐️
      name: Stone Swim
      type: feature
