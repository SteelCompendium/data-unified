...
features:
    - ability_type: Signature Ability
      ...
      effects:
        - roll: Power Roll + 5
          tier1: 15 damage
          tier2: 21 damage; Doru gains an edge on his next power roll; M < 4 [slide](../../../../movement/forced-movement.md) 3
          tier3: 25 damage; Doru has a double edge on his next power roll; M < 5 [slide](../../../../movement/forced-movement.md) 5
    ...
    - cost: 2 Malice
      ...
      effects:
        - roll: Power Roll + 5
          tier1: 5 damage; A < 3 [bleeding](../../../../condition/bleeding.md) (save ends)
          tier2: 11 damage; A < 4 [bleeding](../../../../condition/bleeding.md) (save ends)
          tier3: 15 damage; A < 5 [bleeding](../../../../condition/bleeding.md) (save ends)
      feature_type: ability
      icon: ❇️
      keywords:
        - Area
    ...
    - effects:
        - effect: Doru can't be made [slowed](../../../../condition/slowed.md) or [restrained](../../../../condition/restrained.md). Additionally, he can move while [grabbed](../../../../condition/grabbed.md), and a creature grabbing him moves along with him unless they let go.
      feature_type: trait
      icon: ⭐️
    ...
    - effects:
      ...
      type: feature
    - effects:
        - effect: When Doru is reduced to 0 [Stamina](../../../../rule/health/stamina.md), his loyalty collar explodes, dealing 20 damage to each enemy and object within 3 squares of him.
      feature_type: trait
      icon: ⭐️
