...
features:
    - ability_type: Signature Ability
      ...
      effects:
        - roll: Power Roll + 2
          tier1: 1 psychic damage; vertical [slide](../../../../movement/forced-movement.md) 1
          tier2: 2 psychic damage; vertical [slide](../../../../movement/forced-movement.md) 2
          tier3: 3 psychic damage; vertical [slide](../../../../movement/forced-movement.md) 3
    ...
    - cost: 1 Malice
      ...
      usage: Maneuver
    - effects:
        - effect: When the neuronite is reduced to 0 [Stamina](../../../../rule/health/stamina.md), their loyalty collar explodes, dealing 1d6 damage to each [adjacent](../../../../rule/combat/adjacent.md) enemy and object.
      feature_type: trait
      icon: ⭐️
      name: Loyalty Collar
      type: feature
