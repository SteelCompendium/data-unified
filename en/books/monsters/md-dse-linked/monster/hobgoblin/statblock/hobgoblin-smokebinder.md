...
features:
    - ability_type: Signature Ability
      ...
      effects:
        - roll: Power Roll + 3
          ...
          tier3: 17 fire damage; R < 3 [slowed](../../../condition/slowed.md) (save ends)
    ...
    - effects:
      ...
      type: feature
    - effects:
        - effect: When the smokebinder is reduced to 0 [Stamina](../../../rule/health/stamina.md), they spray burning blood. Each creature [adjacent](../../../rule/combat/adjacent.md) to the smokebinder takes 3 fire damage.
      feature_type: trait
      icon: ⭐️
      name: Infernal Ichor
      type: feature
