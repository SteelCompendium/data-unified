...
features:
    ...
    - distance: Special
      ...
      sections:
        ...
        - label: Effect
          text: The shard releases a shockwave channeled through each creature affected by Psionic Barrier. Each ally in the encounter is [dazed](scc.v1:mcdm.heroes.v1/condition/dazed) until the end of their next turn.
      target: Special
...
>
> **Effect:** The shard releases a shockwave channeled through each creature affected by Psionic Barrier. Each ally in the encounter is [dazed](scc.v1:mcdm.heroes.v1/condition/dazed) until the end of their next turn.
