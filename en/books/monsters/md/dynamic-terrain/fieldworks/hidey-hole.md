...
features:
    - effects:
        - effect: As a maneuver, a creature [adjacent](scc.v1:mcdm.heroes.v1/rule.combat/adjacent) to a hidey-hole can make a **Might test**.
          tier1: The creature is [restrained](scc.v1:mcdm.heroes.v1/condition/restrained) ([save](scc.v1:mcdm.heroes.v1/rule.general/saving-throw) ends).
          tier2: The hidey-hole collapses but the creature is [slowed](scc.v1:mcdm.heroes.v1/condition/slowed) ([save](scc.v1:mcdm.heroes.v1/rule.general/saving-throw) ends).
    ...
    - body: A creature starts the encounter in the hidey-hole or ends their turn there.
      effects:
        - effect: A creature starts the encounter in the hidey-hole or ends their turn there.
