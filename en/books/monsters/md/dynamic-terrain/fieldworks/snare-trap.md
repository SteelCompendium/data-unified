...
features:
    - effects:
        - effect: As a maneuver, a creature [adjacent](scc.v1:mcdm.heroes.v1/rule.combat/adjacent) to a snare trap can make an **Agility test**.
    ...
    - distance: Melee 0
      effects:
        - effect: A creature or object of the appropriate size enters the trap's space.
          name: Trigger
          roll: Power Roll + 2
          tier1: The target [shifts](scc.v1:mcdm.heroes.v1/movement/shifting) 1 square away from the snare.
          tier2: 1 damage; A < 1 [restrained](scc.v1:mcdm.heroes.v1/condition/restrained) ([save](scc.v1:mcdm.heroes.v1/rule.general/saving-throw) ends)
          tier3: 3 damage; A < 2 [restrained](scc.v1:mcdm.heroes.v1/condition/restrained) ([save](scc.v1:mcdm.heroes.v1/rule.general/saving-throw) ends)
