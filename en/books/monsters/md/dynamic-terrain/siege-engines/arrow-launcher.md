...
features:
    - effects:
        - effect: As a maneuver, a creature [adjacent](scc.v1:mcdm.heroes.v1/rule.combat/adjacent) to an arrow launcher can make an **Agility test**.
          tier1: The creature accidentally activates the **Arrow Storm** ability.
          tier2: The arrow launcher is deactivated but the creature is [slowed](scc.v1:mcdm.heroes.v1/condition/slowed) (EoT).
    ...
    - distance: 5 cube within 20
      effects:
        - roll: Power Roll + 2
          tier1: 5 damage; R < 0 [dazed](scc.v1:mcdm.heroes.v1/condition/dazed) ([save](scc.v1:mcdm.heroes.v1/rule.general/saving-throw) ends)
          tier2: 8 damage; R < 1 [dazed](scc.v1:mcdm.heroes.v1/condition/dazed) ([save](scc.v1:mcdm.heroes.v1/rule.general/saving-throw) ends)
          tier3: 11 damage; R < 2 [frightened](scc.v1:mcdm.heroes.v1/condition/frightened) ([save](scc.v1:mcdm.heroes.v1/rule.general/saving-throw) ends)
        - effect: This ability can't be used again until the arrow launcher is reloaded.
          name: Effect
      icon: "\U0001F533"
      keywords:
