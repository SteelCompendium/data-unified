...
Choose one skill you already have from the [crafting skill group](../skill/group/crafting.md). Whenever you obtain a tier 1 outcome on an easy or medium [test](../rule/test/test.md) using this skill, you treat it as a tier 2 outcome instead. Additionally, if you spend 1 minute inspecting an object related to the chosen skill, you can estimate its value and learn of any flaws in its construction.

#### Expert Artisan {data-scc="mcdm.heroes.v1/perk/expert-artisan"}

Whenever you make a [test](../rule/test/test.md) as part of a crafting or [research project](../rule/downtime/research-project.md) that uses a skill you already have from the [crafting skill group](../skill/group/crafting.md), you can make the [power roll](../rule/dice/power-roll.md) twice and use either roll.
...
Without needing to make a [test](../rule/test/test.md)—and even without tools—you can quickly jury-rig or repair a mundane item or piece of equipment related to a skill you have from the [crafting skill group](../skill/group/crafting.md). That item lasts for 1 hour or works for one use or activation (whichever comes first, as the Director determines), then breaks beyond repair. For example, if you have the Carpentry skill, you could repair a rickety wooden bridge long enough for a group of creatures to cross it, or build a simple shovel made of wood that can be used for 1 hour.

#### Inspired Artisan {data-scc="mcdm.heroes.v1/perk/inspired-artisan"}

When you make a [project roll](../rule/downtime/project-roll.md) using a skill from the [crafting skill group](../skill/group/crafting.md), you can spend a [hero token](../rule/resource/hero-token.md) to make another [project roll](../rule/downtime/project-roll.md) for the same project as part of the same [respite](../rule/resource/respite.md) activity. You can't use this perk more than once per [respite](../rule/resource/respite.md).

#### Traveling Artisan {data-scc="mcdm.heroes.v1/perk/traveling-artisan"}

On any day when you don't take a [respite](../rule/resource/respite.md), you can spend 1 uninterrupted hour working on a [crafting project](../rule/downtime/crafting-project.md) using a skill you have from the [crafting skill group](../skill/group/crafting.md). If you do so, you gain 1d10 [project points](../rule/downtime/project-points.md) toward that project.
...
At the start of a [group test](../rule/test/group-test.md) or [montage test](../rule/test/montage-test.md), you can spend a [hero token](../rule/resource/hero-token.md). If you do, all participants make [tests](../rule/test/test.md) as if they also had any skill you have from the [exploration group](../skill/group/exploration.md).
...
When you make a [test](../rule/test/test.md) using a skill from the [exploration skill group](../skill/group/exploration.md) and at least one of the d10s rolled is a 1, you can reroll one d10. You can use this perk only once per [test](../rule/test/test.md).
