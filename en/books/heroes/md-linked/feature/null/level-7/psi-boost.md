...
Whenever you use an ability that is a main action or a maneuver with the Psionic keyword, you can spend additional discipline to apply a [psi boost](psi-boost.md) to it and enhance its effects. A [psi boost](psi-boost.md)'s effects only last until the end of the [turn](../../../rule/combat/turn.md) which the ability is first used. You can apply multiple psi boosts to an ability, but only one instance of each specific boost. You can use the following psi boosts.
