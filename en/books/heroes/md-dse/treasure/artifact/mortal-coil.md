...
Only one destined for death can contain the power of the Mortal Coil. A mortal creature who carries this artifact serves as its host, gaining an additional main action on each of their [turns](scc.v1:mcdm.heroes.v1/rule.combat/turn), aging at ten times the usual rate, and becoming unable to ever regain [Stamina](scc.v1:mcdm.heroes.v1/rule.health/stamina). A host with no natural maximum lifespan permanently reduces their [Stamina](scc.v1:mcdm.heroes.v1/rule.health/stamina) maximum by 10 each year.
...
**One Foot in the Grave:** Any creature in the penumbra has [damage weakness](scc.v1:mcdm.heroes.v1/rule.damage/damage-weakness) 2 and can't regain [Stamina](scc.v1:mcdm.heroes.v1/rule.health/stamina).

**Get Busy Dyin':** Each creature in the penumbra ages at 10 times the usual rate, and diseases and poisons affecting creatures in the penumbra run their course at 10 times their usual rate. A creature with no natural maximum lifespan permanently reduces their [Stamina](scc.v1:mcdm.heroes.v1/rule.health/stamina) maximum by 10 each year. Each creature can undertake one additional [respite](scc.v1:mcdm.heroes.v1/rule.resource/respite) activity during each [respite](scc.v1:mcdm.heroes.v1/rule.resource/respite).
