...
- During the game, the Director is responsible for how the [NPCs](scc.v1:mcdm.heroes.v1/rule.general/npc) and the environment react to the actions of the heroes. This includes changing and skipping prepared scenes and running new scenes on the fly.
...
*Long before the time of Good King Omund, the lands of [Vasloria](scc.v1:mcdm.heroes.v1/rule.world/vasloria) and all of [Orden](scc.v1:mcdm.heroes.v1/rule.world/orden) belonged to the Caelian Empire. The last emperor, Marcus Octavius, held near-omnipotent power, which he used to protect his citizens and extend the borders of the empire. But his greatest general, Actius Vispania, betrayed him and schemed to usurp the throne.*

*Knowing he had discovered this betrayal too late to stop it, Octavius took his knowledge and his weapons and spread them across [Orden](scc.v1:mcdm.heroes.v1/rule.world/orden), sealing them behind powerful wards. All this was done in secret. Even his closest allies did not know the location of the wards, the number of which is now lost to the mists of time. Were there seven? Nine? Legends differ.*
...
As you can see, this opening overview introduces the setting—[Vasloria](scc.v1:mcdm.heroes.v1/rule.world/vasloria) (see [Orden](scc.v1:mcdm.heroes.v1/rule.world/orden) and the Timescape in Chapter 1: [The Basics](scc.v1:mcdm.heroes.v1/chapter/the-basics)). It also gives just enough history and background information for the players to understand their heroes' goal—to recover the knowledge and weapons of the last emperor, sealed behind powerful wards, in order to stop the tyrant Ajax.
...
- **Exploration:** How often are the heroes exploring new environments that are difficult to traverse? How often do you expect the heroes to make [tests](scc.v1:mcdm.heroes.v1/rule.test/test) using skills from the [exploration skill group](scc.v1:mcdm.heroes.v1/skill.group/exploration)?
- **Interpersonal:** How often are the heroes using negotiation and conversing with [NPCs](scc.v1:mcdm.heroes.v1/rule.general/npc) to overcome challenges? How often do you expect the heroes to make [tests](scc.v1:mcdm.heroes.v1/rule.test/test) using skills from the [interpersonal skill group](scc.v1:mcdm.heroes.v1/skill.group/interpersonal)?
- **Intrigue:** How often are the heroes solving mysteries, finding double agents, and skulking about the shadows to achieve their goals? How embroiled will they get in the politics of competing people and factions? How often do you expect the heroes to make [tests](scc.v1:mcdm.heroes.v1/rule.test/test) using skills from the [intrigue skill group](scc.v1:mcdm.heroes.v1/skill.group/intrigue)?
...
- **Exploration:** High. The heroes must traverse [Vasloria](scc.v1:mcdm.heroes.v1/rule.world/vasloria)'s most remote locations to find the wards.
- **Interpersonal:** Low. Heroes will likely interact with other [NPCs](scc.v1:mcdm.heroes.v1/rule.general/npc) as they track down leads on wards, but won't have frequent conversations or negotiations with them.
...
The buy-in tells the players that their heroes are going to travel to far-flung locations, and that it might take them a while to find a home. If a player is looking for a different experience, such as a game that takes place entirely in the city of [Capital](scc.v1:mcdm.heroes.v1/rule.world/capital), they now know that your game isn't for them!

#### Player Option Restrictions

Some campaigns include restrictions on the character options players can choose. For example, a Director might be interested in running a game where the heroes are all [memonek](scc.v1:mcdm.heroes.v1/ancestry/memonek) and [time raiders](scc.v1:mcdm.heroes.v1/ancestry/time-raider) who have come to [Vasloria](scc.v1:mcdm.heroes.v1/rule.world/vasloria) searching for a secret incursion of voiceless talkers. In this case, the Director might restrict all ancestries (see Chapter 3: [Ancestries](scc.v1:mcdm.heroes.v1/chapter/ancestries)) except those two. A campaign about citizens forming a rebellion to take on a tyrannical leader might restrict career options (see Chapter 4: [Background](scc.v1:mcdm.heroes.v1/chapter/background)) so that no one can take Aristocrat or Politician.
...
Writing your own campaign setting and adventures takes time! Maybe you want to save yourself some of that work and instead run a campaign in an official MCDM setting such as [Vasloria](scc.v1:mcdm.heroes.v1/rule.world/vasloria), using our published adventures that take place in that setting. We also allow third-party publishers to make their own *Draw Steel* settings and adventures, so you might want to use one of those instead.
...
You can always change the rules of the game to fit your campaign and taste! Maybe it better suits the pace of the campaign to have a [respite](scc.v1:mcdm.heroes.v1/rule.resource/respite) last 8 hours, or perhaps a [respite](scc.v1:mcdm.heroes.v1/rule.resource/respite) should take a week. You might prefer if [critical hits](scc.v1:mcdm.heroes.v1/rule.combat/critical-hit) are super rare and happen only on a [natural 20](scc.v1:mcdm.heroes.v1/rule.dice/natural-19-20). You could allow heroes to spend [hero tokens](scc.v1:mcdm.heroes.v1/rule.resource/hero-token) to reduce the amount of Malice you have (see *Draw Steel: Monsters*). You might decide that all heroes have a free +1 [bonus](scc.v1:mcdm.heroes.v1/rule.dice/bonuses-and-penalties) to any [characteristic](scc.v1:mcdm.heroes.v1/rule.character/characteristic) of their choice at 1st level.

The rules you create or modify to suit your group are called house rules. You can have as many house rules as you like, but you should discuss these rule changes with the players before [implement](scc.v1:mcdm.heroes.v1/rule.treasure/implement)ing them. If you decide that [critical hits](scc.v1:mcdm.heroes.v1/rule.combat/critical-hit) only occur on a [natural 20](scc.v1:mcdm.heroes.v1/rule.dice/natural-19-20), the worst time for a player to find that out is right after they roll a [natural 19](scc.v1:mcdm.heroes.v1/rule.dice/natural-19-20) in combat.
...
Your top priority should be the campaign's starting location. In which district of [Capital](scc.v1:mcdm.heroes.v1/rule.world/capital) do the players start their first adventure? Which world of the timescape will be the first the heroes visit? What settlement in [Vasloria](scc.v1:mcdm.heroes.v1/rule.world/vasloria) holds their first adventure? Answer that question and get familiar with that place first. You'll have plenty of time to read further as you plan out your games.
...
- **[NPC](scc.v1:mcdm.heroes.v1/rule.general/npc)S:** Write the name, ancestry, age, gender, and a brief note on personality for each [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) the characters might interact with in the locations you've created.
- **Adventure Sites:** Repeat the above two steps for any adventure sites the heroes might visit during their first adventure. Detail the sites, as well as any important [NPCs](scc.v1:mcdm.heroes.v1/rule.general/npc) and villains the heroes might interact with.
...
If you're planning on running a long-arc campaign, you might want to make sure the villain's threat is quieter at certain times. Doing so gives the heroes a chance to take a [respite](scc.v1:mcdm.heroes.v1/rule.resource/respite) now and then and work on their downtime projects.

##### Adventure of the Week

An adventure-of-the-week campaign lets the heroes face an entirely new threat each time a new adventure kicks off. During their first adventure, they might face cultists bringing an undead horde to life. In the next, they battle a band of pirates hell-bent on taking control of a peaceful island. Then it's a race to catch a group of [time raiders](scc.v1:mcdm.heroes.v1/ancestry/time-raider) before they disappear across the timescape with their kidnapped victims.
...
As part of your worldbuilding, you can create an outline of the events that might occur in each [echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon) of your campaign. The farther these events get from the start of the campaign, the vaguer you can leave the details. The actions of the heroes should matter and influence the course of events, so don't plan too much. Otherwise, you might end up throwing out earlier preparation to make player and character decisions matter.

Your outline should include the plans of the villains in your campaign. Review [Echelons](scc.v1:mcdm.heroes.v1/rule.general/echelon) of Play in Chapter 1: [The Basics](scc.v1:mcdm.heroes.v1/chapter/the-basics) to get an idea of the threat level and stories the heroes should be experiencing at each stage of the campaign. An [echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon) outline might look like this:

- **1st [Echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon):** The heroes protect the village of Gravesford in the Barony of Bedegar from the forces of Lord Saxton, an usurper and tyrant loyal to Ajax. Eventually, they must bring the fight to Lord Saxton's keep in Bedegar City.
- **2nd [Echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon):** After toppling Saxton's keep, the heroes find a letter from Ajax detailing plans to amass powerful treasures from throughout [Vasloria](scc.v1:mcdm.heroes.v1/rule.world/vasloria). The heroes can race to these locations to claim the treasures before Ajax's forces do.
- **3rd [Echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon):** With some or all of the treasures secure, it's only a matter of time before Ajax's army seeks out the heroes. The characters can build a coalition of allies to face Ajax, but those allies first require help getting out from under the rule of the Iron [Saint](scc.v1:mcdm.heroes.v1/rule.world/saint).
- **4th [Echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon):** Ajax brings the fight to the heroes. If the Iron [Saint](scc.v1:mcdm.heroes.v1/rule.world/saint) loses, he retreats to his sanctum, where the heroes can follow if they dare.
...
Once you understand a hero's desires for their complication, you can create an [echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon) outline for the complication to give the hero's backstory some narrative teeth throughout the campaign. Consider the following example.

Matt, playing Linn the [talent](scc.v1:mcdm.heroes.v1/class/talent), has the [Elemental Inside](scc.v1:mcdm.heroes.v1/complication/elemental-inside) complication. After discussing the details with the Director, Matt decides that years ago, Linn threw herself in front of a spell cast by Sorin the Brown, an evil earth [elementalist](scc.v1:mcdm.heroes.v1/class/elementalist). Sorin wanted to abduct Linn's [talent](scc.v1:mcdm.heroes.v1/class/talent) mentor, a [dwarf](scc.v1:mcdm.heroes.v1/ancestry/dwarf) who was a perfect subject for her next deadly experiment. In taking decisive action, Linn saved her mentor but absorbed an angry force of earth named Bruulv. Sorin escaped and desires the return of her pet elemental. Meanwhile Linn is tougher thanks to the elemental within, but whenever she is [dying](scc.v1:mcdm.heroes.v1/rule.health/dying), Bruulv takes control of her body and goes on a violent rampage.

Matt tells the Director that Linn enjoys the extra protection afforded to her by Bruulv, since it makes her a tougher hero, and she would like to find a way to keep her benefit while losing the drawback. The Director comes up with an [echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon) outline for Linn that will enrich the [talent's](scc.v1:mcdm.heroes.v1/class/talent) story and have ties to the main campaign (which happens to be the example campaign in the [echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon) outline above).

- **1st [Echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon):** After the heroes start riling up Lord Saxton's forces, Sorin offers her services to the tyrant for a chance to face Linn. During the heroes' assault on the keep, Sorin attacks.
- **2nd [Echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon):** Assuming Sorin's defeat, Bruulv becomes even angrier, and can now try to wrestle control away from Linn whenever she is [winded](scc.v1:mcdm.heroes.v1/rule.health/winded) in addition to when she is [dying](scc.v1:mcdm.heroes.v1/rule.health/dying). Linn finds a Crown of Elements, a special magic treasure that allows her to force Bruulv back to a "takes control only while [dying](scc.v1:mcdm.heroes.v1/rule.health/dying)" state as long as she wears it. The crown has other elemental powers too—and is one of the items desired by Ajax.
- **3rd [Echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon):** As Linn and the other heroes build a coalition, an elderly [high elf](scc.v1:mcdm.heroes.v1/ancestry/high-elf) named Leaves of the Autumn Wind offers to enhance the crown, allowing the [talent](scc.v1:mcdm.heroes.v1/class/talent) to speak directly to Bruulv. The catch is that Leaves needs a magic fire opal from the lair of a fire giant to enhance the crown.
- **4th [Echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon):** With the crown enhanced, Linn can speak directly to Bruulv. By learning the elemental's history and desires through negotiation, she can see that Bruulv mostly wants to return to the City of Brass so they might once again see the raw elemental powers come together. If Linn can visit this city that is literally worlds away, she earns Bruulv's trust and the elemental stops taking over her form.

At each [echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon), you should revisit your complication [echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon) outlines, since the actions of the players could change your plans. In the example outline above, if Sorin gets away after the battle with Saxton during the 1st [echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon), the [elementalist](scc.v1:mcdm.heroes.v1/class/elementalist) is likely to return and try to free Bruulv once again!
...
>
> When you're coming up with ideas for campaigns, adventures, and scenes, you should feel free to steal plots, action set pieces, characters, and anything else you want from your favorite movies, television shows, novels, comic books, and podcasts. You can then modify a few cosmetic details to make things your own. Borrowing a character who's a [human](scc.v1:mcdm.heroes.v1/ancestry/human) man in your favorite novel to make an [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc)? Make the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) a [dwarf](scc.v1:mcdm.heroes.v1/ancestry/dwarf) woman with a new name and no one is the wiser. Got an idea for an encounter based on a battle scene from your favorite science fiction flick? Make those invading aliens gnolls instead! Let your favorite stories inspire you, especially when you're looking for new ideas.
...
Every adventure should have an inciting incident that either sees the heroes discovering the adventure's goal, or that puts them on the path to discovering it. If the characters start an adventure by finding the freshly murdered body of a noble in the streets of [Capital](scc.v1:mcdm.heroes.v1/rule.world/capital), they're likely to look for clues that could lead them to catching a murderer—a solid, straightforward adventure goal. Or it could be that the murder leads them to uncovering a grand conspiracy in which one of [Capital](scc.v1:mcdm.heroes.v1/rule.world/capital)'s Great Houses is planning a coordinated and violent takeover of the city. The heroes must stop those plots—an adventure goal that might take them several scenes to fully uncover. But each of those scenes should lead directly to the next without leaving the players wondering, "What should we do?"
...
The heroes and the fell monsters they slay shouldn't be the only folks in an adventure. A few friendly (or at least nonhostile) [NPCs](scc.v1:mcdm.heroes.v1/rule.general/npc) can supply the characters with information, equipment, and—most importantly—a good reason for putting their lives on the line. If all the people the characters come across are villainous, apathetic, or selfish, the players won't feel very motivated to get their heroics on.

The [NPCs](scc.v1:mcdm.heroes.v1/rule.general/npc) the heroes meet during their adventures should be complex people. They have personal motivations for helping the heroes, personality and behavioral quirks, and character flaws. An adventure typically features at least three or four [NPCs](scc.v1:mcdm.heroes.v1/rule.general/npc) you'll want to flesh out, depending on how many scenes you plan to play out and how many [NPCs](scc.v1:mcdm.heroes.v1/rule.general/npc) each scene requires.

When you create an [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc), quickly jot down the following information about them.

##### Personal Details

What's this [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc)'s name? What do they do for a living?

##### Features

What's notable about the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc)'s appearance? Do they have distinguishing features such as a streak of gray or color in their hair, a bushy beard, a tattoo of a snake skull, or a scar over one eye? Do they have a specific scent (good or bad)?

##### Voice

When the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) speaks, how does their voice sound? You don't have to put on a character voice every time you speak as the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc), but telling the players, "This elf talks like a pirate," or "This [dwarf](scc.v1:mcdm.heroes.v1/ancestry/dwarf) has a high-pitched voice that keeps cracking," helps them remember and differentiate that [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) from others.

##### Behavior

What noticeable behavior does the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) have? Maybe they maintain constant, unbreaking eye contact, or maybe they rarely look up from their feet. They could pick their nose, repeat a catch phrase, talk to themself, bite their nails, whisper whenever they say something profound (or profane!), or constantly clear their throat. Giving an [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) just one distinct behavior helps cement them in the players' minds and makes them more authentic.

##### Flaw

What character flaw does this [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) have? They might be selfish when it comes to wealth, ignore their personal hygiene, lie to cover up their insecurities, or act cowardly in the face of threats. A single flaw does the trick. Too many flaws, and your [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) will go from authentic to authentically unlikable fast.

##### Helping the Heroes

Why would this [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) want to help the heroes during this adventure? They don't have to be fully on board with helping the characters at first. It might take some convincing, in the form of a [test](scc.v1:mcdm.heroes.v1/rule.test/test), a negotiation, or a task the heroes need to accomplish to win the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc)'s help. But there should be at least a kernel of motivation in the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) already—or they have no reason to help. It could be that they don't want the villain to succeed, they see a profitable opportunity in working with the heroes, or they feel they owe the heroes a favor thanks to a previous adventure.

##### Denying Aid

What would prevent this [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) from helping the heroes? It's possible that the answer is "nothing," but most people have something or someone they're not willing to risk even if the fate of the world hangs in the balance. What could the villain threaten that makes the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) think twice about helping out the heroes? It might be a loved one, a meaningful location, or a valuable treasure.
...
- Which [NPCs](scc.v1:mcdm.heroes.v1/rule.general/npc) who the heroes might interact with are found here?
...
Your adventure outline is a document you can use to run your game sessions. It contains information about the villain, the adventure goal, [NPCs](scc.v1:mcdm.heroes.v1/rule.general/npc), locations and sites, and scenes. You can format this outline however you like, whether as fully written sentences, bullet points, a plotting web, or anything else that makes sense to you.

A standard adventure outline contains a bit of overview information regarding the adventure's villain, goal, and [NPCs](scc.v1:mcdm.heroes.v1/rule.general/npc). It then contains a list of locations and sites, with specific sites breaking out the details of each scene that occurs there. The outline then wraps up with a conclusion section discussing the impact the heroes' actions have on the overall campaign and the game world.
...
Director sheets are a resource you can use to prepare and track the progress of characters during combat encounters, negotiations, and [montage tests](scc.v1:mcdm.heroes.v1/rule.test/montage-test). These sheets allow you to track the [objectives](scc.v1:mcdm.heroes.v1/rule.combat/objective) and numbers relevant to the challenge, such as the [Stamina](scc.v1:mcdm.heroes.v1/rule.health/stamina) of enemies, [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) interest and patience, and the number of successes and failures in a [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test). Each sheet has an optional second page you can use to track narrative details, potential rewards, and supporting [NPCs](scc.v1:mcdm.heroes.v1/rule.general/npc) in the scene. You can download these sheets at *https://mcdm.gg/DS-Resources*.
...
- What [bonus](scc.v1:mcdm.heroes.v1/rule.dice/bonuses-and-penalties) pieces of information and other rewards can they earn during this scene if they explore fully and successfully?

Information or objects the heroes need to obtain from an exploration scene to advance the story should have some way of being found without a [test](scc.v1:mcdm.heroes.v1/rule.test/test). Simply by entering a monarch's private chambers, the heroes learn that the king is dead and has been slain by a knife, because his body and the murder weapon are plainly visible. They should also automatically notice that the knife bears the crest of a noble house, providing an obvious path to continue the adventure. Other details in the room might help [speed](scc.v1:mcdm.heroes.v1/rule.character/speed) along their investigation of who killed the king, but they can find the bare minimum of what they need to continue for free.

It's okay for a [test](scc.v1:mcdm.heroes.v1/rule.test/test) to be the *best* way to get necessary information or objects. But if the heroes fail or don't make the [test](scc.v1:mcdm.heroes.v1/rule.test/test), make sure there's another way—likely a more difficult way—for the story to continue. When searching a necromancer's tower for a book that will help stop a ritual, characters might miss all the clues pointing to the book. But they can later run into the necromancer's apprentices, who know where the book is—and who aren't willing to give up that information without a difficult fight.

Other information and rewards the heroes can earn in an exploration scene can be hidden behind [tests](scc.v1:mcdm.heroes.v1/rule.test/test) that can be failed or missed. If heroes don't think to check under the dead king's desk, they don't find the chalice that rolled under there. If they do find the chalice but fail a [Reason](scc.v1:mcdm.heroes.v1/rule.character/reason) [test](scc.v1:mcdm.heroes.v1/rule.test/test) to examine it, they don't learn that the chalice carries the residue of a rare poison, potentially leading them to a nearby alchemist who sells it. They can still solve the mystery without this information,
...
The heroes can usually obtain basic information just by interacting with their environment. If a player asks, "Does it look like the muddy floor of the cave would cling to someone's boots?", getting confirmation doesn't require a [test](scc.v1:mcdm.heroes.v1/rule.test/test). However, following the tracks that lead out of the cave toward the bandits' new hideout does require a [test](scc.v1:mcdm.heroes.v1/rule.test/test), because that's a harder task whose failure gives the bandits extra time to prepare an ambush for when the heroes arrive! If a character wants to meticulously dig through the refuse pile and examine each piece of trash, no [test](scc.v1:mcdm.heroes.v1/rule.test/test) is required to find the torn-up pieces of the map unless they're under serious time pressure to do so. However, a character piecing the map back together needs to succeed on a [Reason](scc.v1:mcdm.heroes.v1/rule.character/reason) [test](scc.v1:mcdm.heroes.v1/rule.test/test) to do so, because failing that task means the heroes obtain only incomplete information as they continue their search.

Chapter 9: [Tests](scc.v1:mcdm.heroes.v1/chapter/tests) explains [tests](scc.v1:mcdm.heroes.v1/rule.test/test) in detail and provides examples of different difficulties of [tests](scc.v1:mcdm.heroes.v1/rule.test/test). A lot of other fantasy games reflexively ask for a roll of the dice anytime a hero attempts a task. However, *Draw Steel* is built around the idea that the Director calls for [tests](scc.v1:mcdm.heroes.v1/rule.test/test) only when failure would make the story more interesting for the heroes and not grind the game to a halt. You might end up asking for fewer [tests](scc.v1:mcdm.heroes.v1/rule.test/test) than you're used to—and that's the way the game is meant to be played!
...
By contrast, sometimes a player will propose what they think is a plausible or clever idea, but you'll think there's no way it could ever succeed. It's fine for you to tell the player, "That's not going to work." You're under no obligation to allow a player to attempt a [test](scc.v1:mcdm.heroes.v1/rule.test/test) that should automatically fail.

##### Test Difficulty

[Tests](scc.v1:mcdm.heroes.v1/rule.test/test) in *Draw Steel* have three levels of outcome, and all players know those outcomes and the dice rolls that generate them. Making a [test](scc.v1:mcdm.heroes.v1/rule.test/test) always means something because every [test](scc.v1:mcdm.heroes.v1/rule.test/test) comes with risks and stakes! Before you call for a [test](scc.v1:mcdm.heroes.v1/rule.test/test), you need to set a difficulty for the [test](scc.v1:mcdm.heroes.v1/rule.test/test) of easy, moderate, or hard.

A hero always succeeds on an **easy [test](scc.v1:mcdm.heroes.v1/rule.test/test)**. It's just a question of whether they might incur a consequence or earn a reward alongside success. For this reason, you should use easy [tests](scc.v1:mcdm.heroes.v1/rule.test/test) sparingly in your adventures.

A hero who has a modifier of +1 or more on a [test](scc.v1:mcdm.heroes.v1/rule.test/test) will likely succeed on a **moderate [test](scc.v1:mcdm.heroes.v1/rule.test/test)**. Success with a consequence is common for heroes if their [bonus](scc.v1:mcdm.heroes.v1/rule.dice/bonuses-and-penalties) to the [test](scc.v1:mcdm.heroes.v1/rule.test/test) is lower than +4, so they're succeeding at a cost. Odds are that most of the [tests](scc.v1:mcdm.heroes.v1/rule.test/test) you'll call for in your games will be moderate [tests](scc.v1:mcdm.heroes.v1/rule.test/test). They give most heroes a decent chance of success without it being a sure thing, and the story gets interesting whenever consequences are involved.

**Hard [tests](scc.v1:mcdm.heroes.v1/rule.test/test)** do exactly what it says on the tin. Success on a hard [test](scc.v1:mcdm.heroes.v1/rule.test/test) requires a roll of 17 or higher, which means a hero has better than a 50 percent chance of success only if they have a +6 or higher [bonus](scc.v1:mcdm.heroes.v1/rule.dice/bonuses-and-penalties) on the [test](scc.v1:mcdm.heroes.v1/rule.test/test). At 1st level, that means a character using their highest [characteristic](scc.v1:mcdm.heroes.v1/rule.character/characteristic), using a skill, and having an [edge](scc.v1:mcdm.heroes.v1/rule.dice/edge) on the [test](scc.v1:mcdm.heroes.v1/rule.test/test). Failure on a hard [test](scc.v1:mcdm.heroes.v1/rule.test/test) often means consequences beyond failing, making hard [tests](scc.v1:mcdm.heroes.v1/rule.test/test) really risky! You likely find that hard [tests](scc.v1:mcdm.heroes.v1/rule.test/test) aren't as common as moderate [tests](scc.v1:mcdm.heroes.v1/rule.test/test) in your game, but they're used more than easy [tests](scc.v1:mcdm.heroes.v1/rule.test/test).

##### Setting Difficulty During Play

When you call for a [test](scc.v1:mcdm.heroes.v1/rule.test/test), you can tell the player making the [test](scc.v1:mcdm.heroes.v1/rule.test/test) the difficulty. Saying "Make a hard [Reason](scc.v1:mcdm.heroes.v1/rule.character/reason) [test](scc.v1:mcdm.heroes.v1/rule.test/test)" can create a dramatic moment at the table as everyone holds their collective breath to see whether the outcome is success, failure, or failure with an additional consequence.

On the other hand, not sharing the difficulty of every [test](scc.v1:mcdm.heroes.v1/rule.test/test) with the players lets you do a little fudging of those difficulties if you want to. You might call for a [test](scc.v1:mcdm.heroes.v1/rule.test/test) and then realize that a [test](scc.v1:mcdm.heroes.v1/rule.test/test) really wasn't necessary even as the player makes the roll. It's easy to simply say, "Hey, sorry. I shouldn't have asked for a [test](scc.v1:mcdm.heroes.v1/rule.test/test). You just do the thing." But if you want to play it cool, remember that every level of an easy [test](scc.v1:mcdm.heroes.v1/rule.test/test) is a success. It's simply a matter of whether a consequence or reward comes with it. If a hero gets an 11 or lower on a [test](scc.v1:mcdm.heroes.v1/rule.test/test) and you think they should still succeed, then the [test](scc.v1:mcdm.heroes.v1/rule.test/test) was easy difficulty.
...
If a [test](scc.v1:mcdm.heroes.v1/rule.test/test) is a **failure**, the hero doesn't do what they set out to do. But even though they don't incur a formal consequence, negative effects can still accompany a failed [test](scc.v1:mcdm.heroes.v1/rule.test/test) depending on circumstances. If a hero attempts to move silently past a group of guards, a failure on the [test](scc.v1:mcdm.heroes.v1/rule.test/test) might draw the guards' attention, but the character should have a chance to react before the alarm is raised. But if the character had incurred a failure with a consequence, they would be spotted immediately as the shouting guards rush to the attack.

If a [test](scc.v1:mcdm.heroes.v1/rule.test/test) is a **success with a consequence**, the hero succeeds but suffers a significant negative effect. They might sneak past the guards successfully but lose their belt pouch in the process, forcing them to decide whether to return for it or move on.

If a [test](scc.v1:mcdm.heroes.v1/rule.test/test) is a **success**, the hero does what they set out to do! You can even let a player narrate the outcome of a successful [test](scc.v1:mcdm.heroes.v1/rule.test/test) by asking them, "How did you pull this off ?"

If the [test](scc.v1:mcdm.heroes.v1/rule.test/test) is a **success with a reward**, the hero does what they set out to do—and then some. A reward might grant another character who needs to make the same [test](scc.v1:mcdm.heroes.v1/rule.test/test) an automatic success, grant an [edge](scc.v1:mcdm.heroes.v1/rule.dice/edge) on a future [test](scc.v1:mcdm.heroes.v1/rule.test/test) for the hero, reveal a hidden treasure the hero wasn't looking for, inspire a nearby [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) to come forth and offer aid, or earn the group a [hero token](scc.v1:mcdm.heroes.v1/rule.resource/hero-token). A reward on a [test](scc.v1:mcdm.heroes.v1/rule.test/test) is yours to choose.

Sample consequences and rewards for [tests](scc.v1:mcdm.heroes.v1/rule.test/test) are detailed in Chapter 9: [Tests](scc.v1:mcdm.heroes.v1/chapter/tests).

#### Creating and Running Hazards

Hazards include traps, natural dangers such as quicksand and avalanches, and [supernatural](scc.v1:mcdm.heroes.v1/rule.general/supernatural) dangers such as magic-irradiated ruins or floating clouds of unstable psionic energy. Hazards can appear in combat and exploration scenes as dangers the heroes need to contend with as they solve other problems. An elaborate hazard can be a scene all on its own as well, whether tackled in a [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test) or run round by round as if it were a combat scenario.
...
All activated hazards have some kind of trigger, and the heroes should be allowed to make [tests](scc.v1:mcdm.heroes.v1/rule.test/test)—typically [Reason](scc.v1:mcdm.heroes.v1/rule.character/reason) or [Intuition](scc.v1:mcdm.heroes.v1/rule.character/intuition) [tests](scc.v1:mcdm.heroes.v1/rule.test/test)—to notice and then disable that trigger. The deadlier the hazard, the harder the [test](scc.v1:mcdm.heroes.v1/rule.test/test).

If a hero doesn't think to search for a trigger before stumbling into a hazard, you can still call for a [test](scc.v1:mcdm.heroes.v1/rule.test/test) to let them notice the trigger when the hazard is about to activate, provided it makes sense to do so. If a hero is about to cross over a tripwire that triggers a trap, you might call for an [Intuition](scc.v1:mcdm.heroes.v1/rule.character/intuition) [test](scc.v1:mcdm.heroes.v1/rule.test/test) to notice the wire at the point when it can be clearly seen. On a failed [test](scc.v1:mcdm.heroes.v1/rule.test/test), the character walks into the tripwire and activates the trap.

Once a trigger is noticed, the heroes might get a chance to disarm it if that's possible. There's probably nothing to be done short of renovating an old mine to stop it from collapsing when anyone damages its walls, but the characters can try to disable a magic rune in a corridor that [teleports](scc.v1:mcdm.heroes.v1/movement/teleport) any creature moving over it into the middle of an ocean. Just remember that trying and failing to disarm a trigger might trigger the hazard!
...
A hero might get a chance to mitigate damage from a hazard, such as by making an [Agility](scc.v1:mcdm.heroes.v1/rule.character/agility) [test](scc.v1:mcdm.heroes.v1/rule.test/test) to outrun or dodge an avalanche, or making a [Reason](scc.v1:mcdm.heroes.v1/rule.character/reason) [test](scc.v1:mcdm.heroes.v1/rule.test/test) to resist the psychic damage of a psionic cloud. You can decide what sort of [test](scc.v1:mcdm.heroes.v1/rule.test/test) needs to be made based on the circumstances.

The One-Time Hazard Deadliness and Perpetual Hazard Deadliness tables show the damage dealt by hazards. Hazards are organized by level, indicating their relative threat compared to the level of the heroes. Each entry features three damage expressions for a tier 1, tier 2, and tier 3 outcome on the [test](scc.v1:mcdm.heroes.v1/rule.test/test) made to mitigate the hazard's damage. The worse the [test](scc.v1:mcdm.heroes.v1/rule.test/test) outcome, the higher the damage.
...
Some hazards deal effects in addition to or instead of damage. A hazard that is part of a combat encounter can impose just about any effect, including [conditions](scc.v1:mcdm.heroes.v1/rule.combat/condition), and can have a real impact on the story. However, if the heroes are facing a hazard outside of combat, you want any effects it imposes to be something more impactful and lasting. The following effects each reflect the interesting and lasting consequences a noncombat hazard should have:

- A character loses a [Recovery](scc.v1:mcdm.heroes.v1/rule.health/recoveries).
- A curse leaves a character with a demonic-sounding voice that imposes a [bane](scc.v1:mcdm.heroes.v1/rule.dice/bane) on [Presence](scc.v1:mcdm.heroes.v1/rule.character/presence) [tests](scc.v1:mcdm.heroes.v1/rule.test/test).
- A character receives a gaping wound that causes them to take 1d10 damage whenever they roll a natural 2 before they next finish a [respite](scc.v1:mcdm.heroes.v1/rule.resource/respite).
- A character is [teleport](scc.v1:mcdm.heroes.v1/movement/teleport)ed into the middle of a nearby body of water.
...
Interaction scenes are similar to exploration scenes, except that the heroes obtain the information and objects they need by talking to one or more [NPCs](scc.v1:mcdm.heroes.v1/rule.general/npc) instead of exploring an area. Just like with an exploration encounter, you make a list of necessary information that the [NPCs](scc.v1:mcdm.heroes.v1/rule.general/npc) can offer to the heroes freely. [NPCs](scc.v1:mcdm.heroes.v1/rule.general/npc) might then have other information or objects they can be convinced to give to the heroes if they make a persuasive argument, do something kind for the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc), or succeed on a [test](scc.v1:mcdm.heroes.v1/rule.test/test).

Interaction scenes aren't full negotiations, which are reserved for adventure-changing conversations. Still, keep in mind that different [NPCs](scc.v1:mcdm.heroes.v1/rule.general/npc) react differently to various forms of persuasion. A coward might be easy to intimidate, while a battle-hardened soldier might be impossible to awe with displays of ferocity. A bribe might work for a corrupt noble, but a goodly queen who already has wealth beyond measure likely has no interest in whatever riches the heroes possess.

Refer to the details you wrote down for your [NPCs](scc.v1:mcdm.heroes.v1/rule.general/npc) while you roleplay them. Keep in mind any distinct behaviors or attitudes you can throw in to help make the scene fun. You don't have to be a great actor to create a memorable interaction scene! Simply describing how an [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) looks, sounds, and acts goes a long way even without doing funny voices. If you want to put on a character voice, go for it—but there's no obligation to.
...
- The more motivations an [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) has, the more likely the heroes are to make easier [tests](scc.v1:mcdm.heroes.v1/rule.test/test) while engaging the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc).
- The more pitfalls an [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) has, the more likely the heroes are to stumble into a topic that [turns](scc.v1:mcdm.heroes.v1/rule.combat/turn) negotiation sour. However, too many pitfalls can feel like a "Gotcha!" setup to players, especially if they don't have time to do a little research or reconnaissance on the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) before going into the negotiation.

#### Plan the Outcomes

It helps to know the various outcomes an [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) might offer during a negotiation ahead of time. An adventure or campaign continuing should never hinge entirely on the outcome of a negotiation. You don't want the story to come grinding to a halt if the heroes fail to secure information, treasure, or help from an [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc). A failed negotiation might mean the adventure gets a lot harder, but should always provide options for continuing when the characters' negotiation skills fail them.

A negotiation has six possible outcomes, but two of those are predetermined. If a negotiation ends with the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) at interest 4, then the heroes get what they want. If the heroes end the negotiation at interest 1, the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) can't offer them anything. Even with four options left wide open, however, setting up outcomes actually requires less prep work than you might think.

> **Multiple [NPCs](scc.v1:mcdm.heroes.v1/rule.general/npc)**
>
> The negotiation rules are built around the idea of the heroes facing off against a single dominant [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc)—a powerful leader, a ranking diplomat, a warlord, a key villain, and so forth. But this isn't to say that you can't run a negotiation with the heroes interacting with a group of [NPCs](scc.v1:mcdm.heroes.v1/rule.general/npc), each with their own slightly different take on wheeling and dealing.
>
> If you set up a negotiation using more than one [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc), you don't give each [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) their own negotiation stats, motivations, and pitfalls. Rather, you assign stats to the group as a whole, then have different [NPCs](scc.v1:mcdm.heroes.v1/rule.general/npc) step to the fore in the negotiation when a particular motivation or pitfall is in play. For example, if you assign the greed pitfall to a group of knights, the well-dressed captain of that group might appear as though they're open to being bribed by the heroes. But when the dour sergeant-at-arms who resents the captain's flamboyant lifestyle angrily rejects the characters' offer, the captain must go along with it to keep the peace among their [followers](scc.v1:mcdm.heroes.v1/rule.general/follower).

If a negotiation ends with the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc)'s interest at 2 or 5, you need to know what the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) might offer the heroes instead of or in addition to their main ask. It's also a good idea to have a list of two favors, items, pieces of information, or other help the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) can offer the heroes, so that you aren't scrambling to think of something if these results come up.

Likewise, if the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc)'s interest hits 3, they'll ask the heroes for a favor in exchange for what's being asked of them. The heroes might also directly ask the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) what they can offer to cinch the negotiation. In this case, it helps to have in mind two favors, items, pieces of information, or other help the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) could ask for from the heroes.

Finally, if the heroes really offend the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) and end the negotiation with their interest at 0, have some idea of what the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) might do to try to punish the heroes. If you don't have this ready, though, don't sweat it. Revenge is a dish best served cold—and maybe a few sessions from now—so you've got time to plan.

#### Hero Negotiation Stats

Many heroes have class features, titles, or other character options that make them better in negotiation. When you're preparing a negotiation, it helps if you know each hero's [Renown](scc.v1:mcdm.heroes.v1/rule.resource/renown) score and any features they have that might impact a negotiation, such as the [troubadour's](scc.v1:mcdm.heroes.v1/class/troubadour) [Scene Partner](scc.v1:mcdm.heroes.v1/feature.troubadour.level-1/scene-partner) feature. Ask your players to tell you if any of their character options influence negotiation at the start of a campaign, and ask again whenever they gain a new level.

#### Heroes Must Initiate

A negotiation should always be initiated by the heroes, and the character (as with people in general) can't be forced to negotiate for something they don't want. As you prepare your negotiation, remember that the players might decide to gain what the characters need from the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) in some other way—calling in a favor from someone else who has the means to help them, stealing what they need from the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc), simply pushing forward without the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc)'s help, and so on.
...
An [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc)'s interest helps you determine their attitude toward the party's proposals, while their patience indicates how much time they're willing to give the heroes. In the same way that [Stamina](scc.v1:mcdm.heroes.v1/rule.health/stamina) tells you when a monster is done with a fight, patience tells you when an [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) is done talking and is ready to deal. The negotiation rules mean you never have to just roleplay a conversation until you and the players become bored with the scene, then someone makes a single [test](scc.v1:mcdm.heroes.v1/rule.test/test) to see what happens. The negotiation rules let you roleplay with structure, risks, and rewards!

The most important thing to remember when it comes to negotiation is that the rules are meant to work with you—not against you. They're flexible on purpose. If a hero makes an excellent argument that you think should work without a [test](scc.v1:mcdm.heroes.v1/rule.test/test), then it does. If a hero makes an unfortunate argument that should fail no matter what, then they're out of luck. You're empowered to run negotiation in whatever way will be the most fun for you and your players.

If players are having trouble roleplaying during a negotiation, try running your next negotiation without announcing that the characters are now in a negotiation. Simply ask them for [tests](scc.v1:mcdm.heroes.v1/rule.test/test) when appropriate and have the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) respond based on the [test](scc.v1:mcdm.heroes.v1/rule.test/test) outcomes and their motivations and pitfalls. This approach might help your players shake off focusing on the rules to simply roleplay as you track interest and patience on the side.

#### Research and Reconnaissance

If the players want to negotiate with an [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) and the heroes have some time before the conversation starts, they might think to do a bit of research and reconnaissance into the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc), hoping to discover their motivations and pitfalls. Characters have multiple ways to tackle this. They might do research into the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) as a downtime project, they could employ a [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test) to gather rumors and grease a few palms, or they might attempt to do favors for people close to the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) and earn information in exchange.
...
When it comes time for you to roleplay an [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) during a negotiation, remember that the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc), like all sapient creatures, is complex. Every [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) has their own way of approaching negotiation. Some might be full of bluster. Others might say everything with a smile even while rejecting the heroes. One [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) might be verbose, while yet another says as little as possible to keep the heroes guessing as to their real desires. As a starting point to figuring out how a specific [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) might negotiate, you can refer to the notes on the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) that you created while preparing the adventure, reviewing their voice, behavior, and flaw, in addition to any motivations for helping or denying characters in need.

One important decision you should make ahead of time is how upfront the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) will be regarding what they want from the heroes. A straightforward [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) can make for a faster negotiation if the heroes are willing to give the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) whatever they need. An unreadable [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) can be a puzzle for the heroes to figure out, and can be more difficult to roleplay. If it's your first time using the negotiation rules, you should start out with a more straightforward [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) before playing a coy customer.
...
Once a negotiation starts, the players and characters can obtain information about the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) involved only by making [tests](scc.v1:mcdm.heroes.v1/rule.test/test), using their characters' features, or through engaging in conversation with the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc). Whenever the [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) makes an offer to the heroes after a [test](scc.v1:mcdm.heroes.v1/rule.test/test), make it clear what the terms of the offer are. While some [NPCs](scc.v1:mcdm.heroes.v1/rule.general/npc) might speak cryptically, it's best for the players to understand what they're getting their heroes into. It can be fun to trick the heroes, but many players don't feel the fun when they get tricked instead.

> **Sharing Interest and Patience**
>
> It's up to you as the Director to decide whether to share an [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc)'s interest or patience during a negotiation. Sometimes sharing this information can make an encounter more dramatic, with the players watching their progress rise and fall in real time. Other groups might find negotiation more fun and immersive if those exact numbers are hidden from the players, just as some groups like knowing the [Stamina](scc.v1:mcdm.heroes.v1/rule.health/stamina) of every creature in a battle and others prefer to keep that information secret. Talk to your players about what they'd prefer.

#### Sample Negotiators

This section contains a number of sample [NPCs](scc.v1:mcdm.heroes.v1/rule.general/npc) you can use for negotiation, sorted by their Impression scores. Each of these [NPCs](scc.v1:mcdm.heroes.v1/rule.general/npc) is an archetype that you can easily adapt to specific situations. For example, the bandit chief could be the leader of a brigand gang, a pirate captain, or a rebel who redistributes wealth by stealing from corrupt nobles and giving the booty to those less fortunate.

Each archetype includes a list of motivations and pitfalls an [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) could have. You should pick at least two from each list for any [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc) you create using the archetype. Feel free to change the wording on motivations and pitfalls and adjust numbers as you see fit.
...
- **Legacy:** Listen, I don't care what happens when I'm gone. I want my [followers](scc.v1:mcdm.heroes.v1/rule.general/follower) shouting my name now, not in a hundred years.
...
The virtuoso archetype can be used for any other local celebrity, such as a [master crafter](scc.v1:mcdm.heroes.v1/title/master-crafter), inspired artist, famous gladiator, or world champion.
...
- **Legacy:** Castles will crumble. Empires will fall. But if only I can produce a work worthy of my [talents](scc.v1:mcdm.heroes.v1/class/talent), my name will live forever.
...
- **Peace:** We must have [stability](scc.v1:mcdm.heroes.v1/rule.character/stability). I will sacrifice anything—and anyone—for this.
...
You can use [montage tests](scc.v1:mcdm.heroes.v1/rule.test/montage-test) to play out chases, escapes, investigations, wilderness travel, attempts to track other creatures, and any other exciting moments in a story that can be told by transitioning or cutting back and forth among the heroes.

#### Preparing Montage Tests

When you prepare a [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test), you'll want to write down some key information.

First, make a list of potential challenges the heroes can face during the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test). This list should be at least as long as the number of successes the heroes must achieve to earn a total success. You might also prepare a list of consequences and rewards that could come up for individual [tests](scc.v1:mcdm.heroes.v1/rule.test/test) made during the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test), but since you can't predict what approaches the players will take to their characters' [tests](scc.v1:mcdm.heroes.v1/rule.test/test), don't worry about covering every scenario. You can always fall back on earning Malice and giving out [hero tokens](scc.v1:mcdm.heroes.v1/rule.resource/hero-token) as a default consequence and reward (see [Test](scc.v1:mcdm.heroes.v1/rule.test/test) Outcomes in Chapter 9: [Tests](scc.v1:mcdm.heroes.v1/chapter/tests)).
...
When you run a [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test), start by setting the scene for the players and listing the various challenges the heroes must overcome. Allow the players to strategize about the order in which they'll tackle these challenges and make [tests](scc.v1:mcdm.heroes.v1/rule.test/test).

When you adjudicate individual [tests](scc.v1:mcdm.heroes.v1/rule.test/test) as part of a [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test), do so as you would any other [test](scc.v1:mcdm.heroes.v1/rule.test/test) (see Adjudicating [Tests](scc.v1:mcdm.heroes.v1/rule.test/test) in Chapter 9: [Tests](scc.v1:mcdm.heroes.v1/chapter/tests)). Individual [tests](scc.v1:mcdm.heroes.v1/rule.test/test) should have rewards and consequences when appropriate. In addition to the usual options for rewards or consequences, you can choose to have those outcomes grant an [edge](scc.v1:mcdm.heroes.v1/rule.dice/edge) or impose a [bane](scc.v1:mcdm.heroes.v1/rule.dice/bane) on a [test](scc.v1:mcdm.heroes.v1/rule.test/test) made later as part of the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test). Do whatever makes sense for the heroes' actions in the narrative.

After each [test](scc.v1:mcdm.heroes.v1/rule.test/test), narrate the hero's failure or success in such a way that the other players can understand if and how the challenge has been overcome. Your description might even spark some new ideas for what the characters can do next.

If a hero decides to tackle a problem using an ability, trait, or other feature instead of a [test](scc.v1:mcdm.heroes.v1/rule.test/test) and it makes sense for them to do so, allow it. In a lot of cases, you can treat that approach as an automatic success that allows the group to overcome one of the challenges of the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test), but you could decide that the success incurs a consequence. Alternatively, maybe the use of an ability or trait is beneficial enough to provide an [edge](scc.v1:mcdm.heroes.v1/rule.dice/edge) on a future [test](scc.v1:mcdm.heroes.v1/rule.test/test), or maybe it's so effective that it counts for multiple successes or solves the entire [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test) in one fell swoop! Always reward the clever actions of the players.

At the end of a [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test), narrate the outcome for the players as you describe the overall success or failure and any consequences. Then let them know the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test) is done!

#### Montage Twist!

You can break up the individual [tests](scc.v1:mcdm.heroes.v1/rule.test/test) within a [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test) by introducing a quick combat encounter, negotiation, or trap into the scene, or by adding more challenges to overcome. Keep track of the heroes' successes and failures, and decide how many [tests](scc.v1:mcdm.heroes.v1/rule.test/test) they must attempt before introducing your twist. A single twist in a [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test) can often be introduced at the end of the first [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test) round.

When a twist is introduced, make sure the players understand that the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test) has been paused but isn't over. Then when the twist has been established and dealt with, continue the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test).

#### Example Montage Tests

You can use any of the following [montage tests](scc.v1:mcdm.heroes.v1/rule.test/montage-test) in your game, or as inspiration that you can modify to your heart's content.
...
The following challenges can be part of the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test):

- **Bucket Brigades:** Characters can organize the would-be firefighters into disciplined bucket brigades, or can fight the fire directly in some other way. *Suggested* C*haracteristics:* [Presence](scc.v1:mcdm.heroes.v1/rule.character/presence), [Reason](scc.v1:mcdm.heroes.v1/rule.character/reason). *Suggested Skills:* Architecture, Intimidate, Lead.
- **Clearing a Firebreak:** Preventing the fire from spreading might involve clearing the ground of flammable materials, either by moving it or burning it away under controlled [conditions](scc.v1:mcdm.heroes.v1/rule.combat/condition). *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Might](scc.v1:mcdm.heroes.v1/rule.character/might), [Reason](scc.v1:mcdm.heroes.v1/rule.character/reason). *Suggested Skills and Abilities:* Endurance, Lift; abilities that deal fire damage. *Special:* A creature loses a [Recovery](scc.v1:mcdm.heroes.v1/rule.health/recoveries) if they incur a consequence on the [test](scc.v1:mcdm.heroes.v1/rule.test/test) for this challenge.
- **Evacuating Buildings:** Characters must save people trapped in burning buildings. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Might](scc.v1:mcdm.heroes.v1/rule.character/might), [Presence](scc.v1:mcdm.heroes.v1/rule.character/presence). *Suggested Skills:* Climb, Endurance, Persuade. *Special:* A creature who doesn't have fire immunity loses a [Recovery](scc.v1:mcdm.heroes.v1/rule.health/recoveries) if they incur a consequence on the [test](scc.v1:mcdm.heroes.v1/rule.test/test) for this challenge. The heroes can attempt this challenge twice during the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test).
- **Find More Firefighters:** By finding groups that aren't fighting the fire, such as fleeing civilians, characters can convince them to help. *Suggested [Characteristic](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Presence](scc.v1:mcdm.heroes.v1/rule.character/presence). *Suggested Skills:* Intimidate, Lead, Persuade.
- **Free the Horses:** Characters can loose the stabled horses threatened by the fire and lead them to safety. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Might](scc.v1:mcdm.heroes.v1/rule.character/might), [Presence](scc.v1:mcdm.heroes.v1/rule.character/presence). *Suggested Skills:* Handle Animals, Lift, Ride.
- **Move Burning Rubble:** [Shifting](scc.v1:mcdm.heroes.v1/movement/shifting) burning debris blocking doorways can allow people to escape the blaze. *Suggested [Characteristic](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Might](scc.v1:mcdm.heroes.v1/rule.character/might). *Suggested Skills:* Endurance, Lift. *Special:* A creature who doesn't have fire immunity loses a [Recovery](scc.v1:mcdm.heroes.v1/rule.health/recoveries) if they incur a consequence on the [test](scc.v1:mcdm.heroes.v1/rule.test/test) for this challenge.
- **Use the Freed Horses (if the Free the Horses challenge was successful):**  Characters can put the horses to work clearing rubble or bringing people to safety. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Reason](scc.v1:mcdm.heroes.v1/rule.character/reason), [Presence](scc.v1:mcdm.heroes.v1/rule.character/presence). *Suggested Skills:* Drive, Handle Animals, Ride.

###### Optional Twists

At the end of the first [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test) round, an emergency crops up. One or more heroes, selected by the players, must deal with the situation before the end of the round. If the heroes successfully deal with the twist, they earn a success for the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test). Otherwise, they earn a failure.

- **Building Collapse:** While a hero is in or near a blazing building, it starts to collapse. The hero must escape before the building crumbles. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Agility](scc.v1:mcdm.heroes.v1/rule.character/agility), [Intuition](scc.v1:mcdm.heroes.v1/rule.character/intuition). *Suggested Skills:* Climb, Gymnastics, Jump.
- **Cause of the Fire:** At the end of the first round of the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test), the hostile cause of the fire appears—a squad of an invading army, a dragon, a team of arsonists, and so forth. The characters must engage in a standard or hard encounter with this threat.
- **Help!** Townsfolk are about to run into a burning building to save a trapped relative. This twist requires two [tests](scc.v1:mcdm.heroes.v1/rule.test/test), each of which nets a success or a failure for the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test). One hero can try to prevent the townspeople from entering the burning building while another rescues the relative. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Might](scc.v1:mcdm.heroes.v1/rule.character/might), [Presence](scc.v1:mcdm.heroes.v1/rule.character/presence). *Suggested Skills:* Lift, Persuade.

###### Montage Test Outcomes

One of the following outcomes ends the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test):

- **Total Success:** The fire is extinguished. Buildings are damaged but no lives were lost. Each character earns 2 [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) if the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test) was hard, or 1 [Victory](scc.v1:mcdm.heroes.v1/rule.resource/victories) if it was easy or moderate, in addition to any [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) earned from combat during the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test).
- **Partial Success:** The fire is quenched, although many buildings burned and a few lives were lost. Each character earns 1 [Victory](scc.v1:mcdm.heroes.v1/rule.resource/victories) if the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test) was moderate or hard, in addition to any [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) earned from combat during the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test).
- **Total Failure:** When the fire finally burns out, the town lies in ruins. Townsfolk mourn their dead or grimly prepare to find a new home. Characters earn no [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) from the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test), but might earn [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) from combat undertaken during the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test).
...
Half the work of any successful infiltration is done before setting foot in the target site. The players can choose to have the heroes make individual [tests](scc.v1:mcdm.heroes.v1/rule.test/test) as part of the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test) before they attempt to enter the palace. One round of [tests](scc.v1:mcdm.heroes.v1/rule.test/test) can be made this way, and those [tests](scc.v1:mcdm.heroes.v1/rule.test/test) don't affect the alarm level within the palace (see below).

The following challenges can be part of this initial preparation:

- **Bribe Guards:** The heroes can pay off the guards outside the palace to look the other way. If successful, one or more heroes' [Wealth](scc.v1:mcdm.heroes.v1/rule.resource/wealth) is lowered by 1. *Suggested [Characteristic](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Presence](scc.v1:mcdm.heroes.v1/rule.character/presence). *Suggested Skills:* Criminal Underworld, Flirt, Persuade.
- **Find Blueprints:** Researching secret entrances and little-known passageways can be undertaken in forgotten libraries or well-guarded town halls. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Agility](scc.v1:mcdm.heroes.v1/rule.character/agility), [Reason](scc.v1:mcdm.heroes.v1/rule.character/reason). *Suggested Skills:* Architecture, History, Sneak.
- **Identify Unguarded Entrances:** Scouting around or consulting contacts can reveal a forgotten back door or accessible window. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Agility](scc.v1:mcdm.heroes.v1/rule.character/agility), [Intuition](scc.v1:mcdm.heroes.v1/rule.character/intuition). *Suggested Skills:* Alertness, Architecture, Criminal Underworld.
- **Learn Guard Schedules:** By keeping their ears and eyes open, characters can learn when guards go off duty. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Intuition](scc.v1:mcdm.heroes.v1/rule.character/intuition), [Reason](scc.v1:mcdm.heroes.v1/rule.character/reason). *Suggested Skills:* Alertness, Eavesdrop, Track.
- **Use False Identities:** By procuring forged documents or badges, characters can prepare to walk into the palace in plain sight. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Presence](scc.v1:mcdm.heroes.v1/rule.character/presence), [Reason](scc.v1:mcdm.heroes.v1/rule.character/reason). *Suggested Skills:* Disguise, Forgery, Lie.

When the heroes start their infiltration, the alarm level of the palace starts at 0. While they infiltrate the site, whenever any hero fails a [test](scc.v1:mcdm.heroes.v1/rule.test/test) as part of the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test), the alarm level increases by 1, to a maximum of 2. Each time the heroes succeed on such a [test](scc.v1:mcdm.heroes.v1/rule.test/test), the alarm level decreases, to a minimum of 0. While the alarm level is 1, [tests](scc.v1:mcdm.heroes.v1/rule.test/test) made inside the palace by the characters as part of the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test) take a [bane](scc.v1:mcdm.heroes.v1/rule.dice/bane). While the alarm level is 2, such [tests](scc.v1:mcdm.heroes.v1/rule.test/test) have a double [bane](scc.v1:mcdm.heroes.v1/rule.dice/bane).

The first time any hero fails a [test](scc.v1:mcdm.heroes.v1/rule.test/test) made as part of the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test) while the alarm level is 2, they encounter guards and must engage in a hard combat encounter. The second time any hero fails such a [test](scc.v1:mcdm.heroes.v1/rule.test/test) while the alarm level is 2, the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test) is a total failure.

The following challenges can be part of the heroes' infiltration:

- **Aerial Route:** Characters can follow a path that leads along catwalks or high ledges. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Agility](scc.v1:mcdm.heroes.v1/rule.character/agility), [Might](scc.v1:mcdm.heroes.v1/rule.character/might). *Suggested Skills:* Climb, Gymnastics, Jump.
- **Avoid Traffic:** By finding the dustiest, least-traveled areas and sticking to them, characters can avoid notice. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Intuition](scc.v1:mcdm.heroes.v1/rule.character/intuition), [Reason](scc.v1:mcdm.heroes.v1/rule.character/reason). *Suggested Skills:* Navigate, Search, Track.
- **Lie Low:** Once while the alarm level is greater than 0, the heroes can find a place to hide for a bit, reducing the alarm level by 1. This activity doesn't require a [test](scc.v1:mcdm.heroes.v1/rule.test/test) or generate a success or failure.
- **Make a Diversion:** After causing a ruckus, the characters quickly go the other way. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Might](scc.v1:mcdm.heroes.v1/rule.character/might), [Presence](scc.v1:mcdm.heroes.v1/rule.character/presence). *Suggested Skills:* Alchemy, Perform, Sabotage.
- **Pose as Guards:** Using stolen or specially prepared uniforms can let the characters move freely through the palace. The [test](scc.v1:mcdm.heroes.v1/rule.test/test) for this challenge gains an [edge](scc.v1:mcdm.heroes.v1/rule.dice/edge) if the characters prepared disguises in advance (including succeeding on the Use False Identities challenge) or defeated guards during their infiltration. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Intuition](scc.v1:mcdm.heroes.v1/rule.character/intuition), [Presence](scc.v1:mcdm.heroes.v1/rule.character/presence). *Suggested Skills:* Disguise, Lie, Search.
- **Skulk in the [Shadows](scc.v1:mcdm.heroes.v1/class/shadow):** Keeping out of sight is the simplest way for characters to move through the palace. *Suggested [Characteristic](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Agility](scc.v1:mcdm.heroes.v1/rule.character/agility). *Suggested Skills:* Hide, Sneak. *Special:* The heroes can attempt this challenge twice during the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test).

###### Optional Twist

At any time during the infiltration section of the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test), immediately after one hero's [turn](scc.v1:mcdm.heroes.v1/rule.combat/turn), the characters run into another group breaking into the palace at the same time, and possibly after the same prize. The characters can choose to fight or negotiate with the other party, or simply let them pass—in which case they might meet them again when they reach their final goal.

###### Montage Test Outcomes

One of the following outcomes ends the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test):

- **Total Success:** The heroes reach their goal and secure an escape route that lets them leave the palace safely. Each character earns 2 [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) if the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test) was hard, or 1 [Victory](scc.v1:mcdm.heroes.v1/rule.resource/victories) if it was easy or moderate, in addition to any [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) earned from combat during the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test).
- **Partial Success:** The heroes reach their goal, but they need to fight a standard combat encounter to escape the palace. Each character earns 1 [Victory](scc.v1:mcdm.heroes.v1/rule.resource/victories) if the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test) was moderate or hard, in addition to any [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) earned from combat during the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test).
- **Total Failure:** The palace is locked down and the heroes' goal is out of reach. The characters need to fight a hard combat encounter to escape. Characters earn no [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) from the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test), but might earn [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) from combat undertaken during the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test).
...
- **Arms and Armor:** Crafting or repairing weapons and armor of all kinds can help rebuild the defenders' stores. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Might](scc.v1:mcdm.heroes.v1/rule.character/might), [Reason](scc.v1:mcdm.heroes.v1/rule.character/reason). *Suggested Skills:* Alchemy, Blacksmithing, Fletching.
- **Evacuation:** Heroes can help get noncombatants to safety before the invaders arrive. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Intuition](scc.v1:mcdm.heroes.v1/rule.character/intuition), [Presence](scc.v1:mcdm.heroes.v1/rule.character/presence). *Suggested Skills:* Handle Animals, Lead, Persuade.
- **Fortification:** Characters can help build or repair walls and other defensive structures. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Might](scc.v1:mcdm.heroes.v1/rule.character/might), [Reason](scc.v1:mcdm.heroes.v1/rule.character/reason). *Suggested Skills:* Architecture, Endurance, Lift.
- **Inspiration:** Improving morale with rousing speeches or performances can help prepare the locals for the fight to come. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Intuition](scc.v1:mcdm.heroes.v1/rule.character/intuition), [Presence](scc.v1:mcdm.heroes.v1/rule.character/presence). *Suggested Skills:* Brag, Lead, Perform.
- **Propaganda:** Characters can attempt to sow confusion or rebellion in the ranks of the approaching army. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Agility](scc.v1:mcdm.heroes.v1/rule.character/agility), [Presence](scc.v1:mcdm.heroes.v1/rule.character/presence). *Suggested Skills:* Disguise, Forgery, Lie.
- **Stockpiling:** Characters can hunt, forage, or [supernatural](scc.v1:mcdm.heroes.v1/rule.general/supernatural)ly conjure food or water to augment the settlement's supplies. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Agility](scc.v1:mcdm.heroes.v1/rule.character/agility), [Reason](scc.v1:mcdm.heroes.v1/rule.character/reason). *Suggested Skills:* Nature, Sneak, Track.
- **Training:** Heroes can help to train the settlement's defenders. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Might](scc.v1:mcdm.heroes.v1/rule.character/might), [Presence](scc.v1:mcdm.heroes.v1/rule.character/presence). *Suggested Skills:* Endurance, Intimidate, Lead.
- **Trapmaking:** Digging concealed pits, placing hindrances, and setting up ambushes will make it harder for the invaders to approach the settlement. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Might](scc.v1:mcdm.heroes.v1/rule.character/might), [Reason](scc.v1:mcdm.heroes.v1/rule.character/reason). *Suggested Skills:* Conceal Object, Endurance, Mechanics.

###### Optional Twist

At the end of the first round of the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test), a fast-moving enemy vanguard attacks before the settlement's defenders are ready. The heroes must engage in an easy combat encounter.

###### Montage Test Outcomes

One of the following outcomes ends the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test):

- **Total Success:** The settlement is fully fortified, and even if the heroes don't fight in its defense, the settlement and its people survive. If the heroes wish, they can leave the settlement and fight a standard combat encounter against the leader of the invaders and their lackeys, possibly killing or capturing the leader. Each character earns 2 [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) if the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test) was hard, or 1 [Victory](scc.v1:mcdm.heroes.v1/rule.resource/victories) if it was easy or moderate, in addition to any [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) earned from combat during the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test).
- **Partial Success:** The settlement's fortifications are improved, but the settlement will still fall unless the heroes fight in its defense. To save the settlement, the heroes must triumph in a hard combat encounter against the leader of the invaders and their lackeys. If the heroes lose the encounter, the settlement falls. Each character earns 1 [Victory](scc.v1:mcdm.heroes.v1/rule.resource/victories) if the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test) was moderate or hard, in addition to any [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) earned from combat during the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test).
- **Total Failure:** The heroes each lose a [Recovery](scc.v1:mcdm.heroes.v1/rule.health/recoveries) from their failed efforts to defend the settlement, which is taken over by the invaders. If the players wish, the characters can fight two hard combat encounters against waves of invaders to allow some of the settlement's inhabitants to retreat to safety. Characters earn no [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) from the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test), but might earn [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) from combat undertaken during the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test).
...
- **Ask Around:** Characters can gather clues from locals or bystanders—or if they have access to the proper magic, from animals or the dead. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Intuition](scc.v1:mcdm.heroes.v1/rule.character/intuition), [Presence](scc.v1:mcdm.heroes.v1/rule.character/presence). *Suggested Skills:* Interrogate, Persuade, Rumors.
- **Follow the Trail:** Looking for tracks or other signs of the fugitive's passage can lead the characters on. *Suggested [Characteristic](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Intuition](scc.v1:mcdm.heroes.v1/rule.character/intuition). *Suggested Skills:* Alertness, Search, Track. *Special:* The heroes can attempt this challenge twice during the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test).
- **Obtain a Good View:** Characters can climb up high to get the big picture of where the fugitive might have gone. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Agility](scc.v1:mcdm.heroes.v1/rule.character/agility), [Might](scc.v1:mcdm.heroes.v1/rule.character/might). *Suggested Skills:* Climb, Gymnastics, Jump.
- **Predict the Next Move:** The heroes might have an idea where the quarry is headed. A character gains an [edge](scc.v1:mcdm.heroes.v1/rule.dice/edge) on the [test](scc.v1:mcdm.heroes.v1/rule.test/test) for this challenge if they know the quarry well. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Intuition](scc.v1:mcdm.heroes.v1/rule.character/intuition), [Reason](scc.v1:mcdm.heroes.v1/rule.character/reason). *Suggested Skills:* Navigate, Read Person, an appropriate skill from the [lore skill group](scc.v1:mcdm.heroes.v1/skill.group/lore) (Nature to follow an animal, Criminal Underworld to follow a criminal, and so forth).
- **Push Ahead:** While the quarry is resting, the heroes have a chance to close in. Suggested [Characteristic](scc.v1:mcdm.heroes.v1/rule.character/characteristic): [Might](scc.v1:mcdm.heroes.v1/rule.character/might). Suggested Skills: Drive, Endurance, Navigate, Ride. Special: The hero making the [test](scc.v1:mcdm.heroes.v1/rule.test/test) for this challenge loses a [Recovery](scc.v1:mcdm.heroes.v1/rule.health/recoveries).

###### Optional Twist

At the end of the first round of the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test), the heroes stumble upon a trap set by the quarry or a problem they left behind. This might include such things as a pit trap set with poison spikes, a mob of angry locals who've been told the characters are criminals, or an intentionally set fire. The heroes must deal with the trap or problem before they continue the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test).

###### Montage Test Outcomes

One of the following outcomes ends the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test):

- **Total Success:** The heroes catch their quarry before the fugitive reaches their destination, or before a lost or kidnapped creature comes to harm. Each character earns 2 [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) if the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test) was hard, or 1 [Victory](scc.v1:mcdm.heroes.v1/rule.resource/victories) if it was easy or moderate, in addition to any [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) earned from combat during the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test).
- **Partial Success:** If the quarry was trying to evade capture, they reach their destination. They find allies and a fortified position from which to defend themselves, or they might have time to cause more harm. If the quarry was lost or kidnapped, they are grievously injured when found. Each character earns 1 [Victory](scc.v1:mcdm.heroes.v1/rule.resource/victories) if the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test) was moderate or hard, in addition to any [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) earned from combat during the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test).
- **Total Failure:** The trail has gone cold, and the heroes will need to seek fresh clues or a different approach before they can resume the hunt. Characters earn no [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) from the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test), but might earn [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) from combat undertaken during the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test).
...
- **Avoid Hazards:** Characters can determine ways to overcome the natural hazards of the wilderness, such as finding insect-repelling herbs in a swamp or making snowshoes to cross tundra. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Intuition](scc.v1:mcdm.heroes.v1/rule.character/intuition), [Reason](scc.v1:mcdm.heroes.v1/rule.character/reason). *Suggested Skills:* Heal, Nature, appropriate skill from the [crafting skill group](scc.v1:mcdm.heroes.v1/skill.group/crafting) (such as Alchemy to make bug repellent).
- **Carry Baggage:** By carrying supplies for weaker party members, characters can increase the whole party's [speed](scc.v1:mcdm.heroes.v1/rule.character/speed). *Suggested [Characteristic](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Might](scc.v1:mcdm.heroes.v1/rule.character/might). *Suggested Skills:* Endurance, Lift.
- **Find the Path:** Avoiding getting lost is a major challenge for the characters. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Intuition](scc.v1:mcdm.heroes.v1/rule.character/intuition), [Reason](scc.v1:mcdm.heroes.v1/rule.character/reason). *Suggested Skills:* Alertness, Nature, Navigate.
- **Keep Up Spirits:** Characters can keep up the party's morale during a forced march with cheer and song. *Suggested [Characteristic](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Presence](scc.v1:mcdm.heroes.v1/rule.character/presence). *Suggested Skills:* Lead, Music, Perform.
- **Keep Watch:** Characters must be on constant guard against danger. *Suggested [Characteristic](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Intuition](scc.v1:mcdm.heroes.v1/rule.character/intuition). *Suggested Skills:* Alertness, Eavesdrop, Track.
- **Push On:** Characters must be ready to pick up the pace and push past their fatigue. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Might](scc.v1:mcdm.heroes.v1/rule.character/might). *Suggested Skills:* Endurance, Lead; Drive, Handle Animals, or Ride if the party has mounts or vehicles.
- **Scout Ahead:** Investigating the path ahead lets the characters avoid dead-ends and arduous terrain. *Suggested [Characteristics](scc.v1:mcdm.heroes.v1/rule.character/characteristic):* [Agility](scc.v1:mcdm.heroes.v1/rule.character/agility), [Intuition](scc.v1:mcdm.heroes.v1/rule.character/intuition). *Suggested Skills:* Alertness, Navigate, Sneak.

###### Optional Twist

At the end of the first round of the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test), the characters' journey is interrupted by one of the following threats:

**Predatory Monster:** The characters stumble into or are stalked by a monstrous predator, and must engage in a standard combat encounter to overcome the threat or drive it off. If any character has obtained a success on the Scout Ahead challenge, you can let the characters make a [group test](scc.v1:mcdm.heroes.v1/rule.test/group-test) to sneak past or set an ambush for the monster.

**Unexpected Hazard:** A natural hazard such as an avalanche, rockslide, or wildfire interrupts the journey. Each hero must make a [test](scc.v1:mcdm.heroes.v1/rule.test/test) of your choice to avoid the hazard, losing a [Recovery](scc.v1:mcdm.heroes.v1/rule.health/recoveries) on a failure.

###### Montage Test Outcomes

One of the following outcomes ends the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test):

- **Total Success:** The heroes reach their goal in time. Each character earns 2 [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) if the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test) was hard, or 1 [Victory](scc.v1:mcdm.heroes.v1/rule.resource/victories) if it was easy or moderate, in addition to any [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) earned from combat during the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test).
- **Partial Success:** To reach their goal in time, the heroes must sprint over the last leg of the journey, with each character spending 2 [Recoveries](scc.v1:mcdm.heroes.v1/rule.health/recoveries) to do so. (If even one character doesn't have 2 [Recoveries](scc.v1:mcdm.heroes.v1/rule.health/recoveries) remaining, the characters instead earn a total failure for the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test).) Each character earns 1 [Victory](scc.v1:mcdm.heroes.v1/rule.resource/victories) if the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test) was moderate or hard, in addition to any [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) earned from combat during the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test).
- **Total Failure:** The heroes don't arrive in time to avert catastrophe. Characters earn no [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) from the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test), but might earn [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) from combat undertaken during the [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test).

### Running Respites

When the heroes decide to take a [respite](scc.v1:mcdm.heroes.v1/rule.resource/respite) (see [Respite](scc.v1:mcdm.heroes.v1/rule.resource/respite) in Chapter 1: [The Basics](scc.v1:mcdm.heroes.v1/chapter/the-basics)), your role as Director changes a bit. Most of the heroes' activities during [respites](scc.v1:mcdm.heroes.v1/rule.resource/respite) revolve around downtime projects, which are typically self-directed. However, you still have levers you can pull to make the story interesting.

#### Safe Place

Heroes can't take a [respite](scc.v1:mcdm.heroes.v1/rule.resource/respite) unless they're in a safe place. This typically means a place with a bed and four walls and a roof around them, where they're unlikely to get stabbed in their sleep. Characters aren't going to find 24 hours of peace to take a [respite](scc.v1:mcdm.heroes.v1/rule.resource/respite) in a villain's lair, even if they barricade a door. However, this can become more of a gray area if the heroes attempt to take a [respite](scc.v1:mcdm.heroes.v1/rule.resource/respite) while traveling in the wild.

"Why can't we camp in this seemingly peaceful wode for a day?" is the kind of thing you might decide is fine if you want the characters to be able to regain [Stamina](scc.v1:mcdm.heroes.v1/rule.health/stamina) and [Recoveries](scc.v1:mcdm.heroes.v1/rule.health/recoveries). Alternatively, you might want them to work harder for those resources, marking the wode as a dangerous place in the story. If the players want the heroes to take a [respite](scc.v1:mcdm.heroes.v1/rule.resource/respite) in a place you deem unsafe, let them know it's impossible to get any meaningful rest or make progress on projects in that place while remaining constantly on guard for danger.

#### Too Many Respites?

It's up to the players how many [respites](scc.v1:mcdm.heroes.v1/rule.resource/respite) the heroes take in a row. Characters eager to take a long series of [respites](scc.v1:mcdm.heroes.v1/rule.resource/respite) to undertake downtime projects (Chapter 12: [Downtime Projects](scc.v1:mcdm.heroes.v1/chapter/downtime-projects)) is fine, but they should always feel pressure to get back to the fight. Remember that villains don't stop plotting and conquering while the heroes rest. Their plans continue! If the characters are taking their sweet time with [respites](scc.v1:mcdm.heroes.v1/rule.resource/respite) so they can create as many Healing Potions as possible, have them get wind of the latest evil actions that nearby villains are taking. Heroes wanting to defend the people and values they love had better stop respiting and start adventuring.

If you prefer a campaign that has few [respites](scc.v1:mcdm.heroes.v1/rule.resource/respite), you might want to deploy artisans, sages, and readily available [project sources](scc.v1:mcdm.heroes.v1/rule.downtime/project-source) to allow the heroes a chance to craft useful items and do research, since their available time to do so will be limited.

#### Project Events

Downtime project events are a Director's time to shine during downtime. Remember that these events (detailed in Chapter 12: [Downtime Projects](scc.v1:mcdm.heroes.v1/chapter/downtime-projects)) are optional, and you can use them as frequently as you like. In general, more than one or two events per [respite](scc.v1:mcdm.heroes.v1/rule.resource/respite) can be disruptive to the overall campaign. It's also fine to have no events if you just want to keep the campaign's main story rolling along.
...
If your play time is limited, you can have the players do everything they need to do during a [respite](scc.v1:mcdm.heroes.v1/rule.resource/respite) between your game sessions, provided they end a game session by taking a [respite](scc.v1:mcdm.heroes.v1/rule.resource/respite). Doing so lets you run any events over email or through a chat app. Then when folks return for the next session, they'll be ready to go with [project rolls](scc.v1:mcdm.heroes.v1/rule.downtime/project-roll) completed, [XP](scc.v1:mcdm.heroes.v1/rule.resource/experience) tallied, and [Stamina](scc.v1:mcdm.heroes.v1/rule.health/stamina) and [Recoveries](scc.v1:mcdm.heroes.v1/rule.health/recoveries) restored.

#### How Many Respites?

There's no right number of [respites](scc.v1:mcdm.heroes.v1/rule.resource/respite) that works for every group. If you want the characters to be able to craft and research, you'll want to give them more downtime to do so. If you prefer to hand out all the treasure and secrets through adventuring, then they'll need fewer [respites](scc.v1:mcdm.heroes.v1/rule.resource/respite). A good pace for many games sees the heroes taking between ten and twenty [respites](scc.v1:mcdm.heroes.v1/rule.resource/respite) during each level of play, with many of those [respites](scc.v1:mcdm.heroes.v1/rule.resource/respite) strung together.

##### Victories and Respites

Ultimately, the players, not the Director, decide when the heroes take a [respite](scc.v1:mcdm.heroes.v1/rule.resource/respite). So even though you adjudicate whether the [conditions](scc.v1:mcdm.heroes.v1/rule.combat/condition) are safe enough for a [respite](scc.v1:mcdm.heroes.v1/rule.resource/respite), this part of the pacing is effectively out of your hands. Typically, most heroes want to rest after every 4 to 6 [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) they earn, depending on how many [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) were earned in combat encounters.

#### Optional Rule: Average Roll

When the heroes take a long series of [respites](scc.v1:mcdm.heroes.v1/rule.resource/respite), it might not be fun for the players to do a ton of die rolling covering many projects. Instead of rolling, you can calculate the progress for each [respite](scc.v1:mcdm.heroes.v1/rule.resource/respite) as if a hero had rolled a natural 11 on their progress roll, then adding appropriate [bonus](scc.v1:mcdm.heroes.v1/rule.dice/bonuses-and-penalties)es. Although rolling lots of dice and hoping for breakthroughs can be a lot of fun, taking the average of the 2d10 roll allows players to get through a lot of downtime with minimal math.

#### Optional Rule: Easier Crafting

Every [crafting project](scc.v1:mcdm.heroes.v1/rule.downtime/crafting-project) requires that a hero obtain the project's [item prerequisite](scc.v1:mcdm.heroes.v1/rule.downtime/item-prerequisite) and a [project source](scc.v1:mcdm.heroes.v1/rule.downtime/project-source) in a specific language before the project can be started. These requirements exist so you can control the pace at which heroes can craft an arsenal of treasures to defeat their foes.

That said, you can make it easier to craft treasures and other items by changing the rules to require either the [item prerequisite](scc.v1:mcdm.heroes.v1/rule.downtime/item-prerequisite) or the [project source](scc.v1:mcdm.heroes.v1/rule.downtime/project-source) but not both, or by removing the language restrictions on [project sources](scc.v1:mcdm.heroes.v1/rule.downtime/project-source). This works well in campaigns that don't have a lot of [respites](scc.v1:mcdm.heroes.v1/rule.resource/respite). Just keep in mind that removing these barriers can lead to the heroes crafting more items and unbalancing the game in their favor.

### Granting Rewards

You should have as much fun giving out treasure, [Renown](scc.v1:mcdm.heroes.v1/rule.resource/renown), wealth, and titles to the characters as the players have earning those rewards (see Chapter 13: [Rewards](scc.v1:mcdm.heroes.v1/chapter/rewards)). But what's the right amount of treasure to give out without turning the heroes into total badasses who can simply cut down every dragon they meet? How often do the rules of the game expect a hero to earn [Renown](scc.v1:mcdm.heroes.v1/rule.resource/renown)? What about titles? This section has answers for you!

#### Granting Treasures

Whenever you're planning on awarding treasures to the heroes, focus on items that are useful. Finding a magic bow isn't likely to excite a group that doesn't have a hero who loves [ranged](scc.v1:mcdm.heroes.v1/rule.combat/ranged) weapon combat. The players might even tell you (or you can ask) which treasures their heroes most desire.
...
- A party should earn two [leveled treasures](scc.v1:mcdm.heroes.v1/rule.treasure/leveled-treasure) per hero by 10th level. Some heroes need only one [leveled treasure](scc.v1:mcdm.heroes.v1/rule.treasure/leveled-treasure) to be happy, though, so if you feel as if giving out another [leveled treasure](scc.v1:mcdm.heroes.v1/rule.treasure/leveled-treasure) wouldn't actually help a character, you can swap that item out for a [trinket](scc.v1:mcdm.heroes.v1/rule.treasure/trinket) of the character's current [echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon).
- A party should earn one [trinket](scc.v1:mcdm.heroes.v1/rule.treasure/trinket) per hero per [echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon). Any [trinket](scc.v1:mcdm.heroes.v1/rule.treasure/trinket) earned should be of a character's current [echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon) or lower.
- A party should also earn one to three [consumables](scc.v1:mcdm.heroes.v1/rule.treasure/consumable) of their current [echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon) or lower each level.

You don't have to award the full complement of treasure to heroes especially those using their downtime to craft things! You can spread out the pace at which characters earn treasures by having them find the [project sources](scc.v1:mcdm.heroes.v1/rule.downtime/project-source) and [item prerequisites](scc.v1:mcdm.heroes.v1/rule.downtime/item-prerequisite) for crafting an item instead of finding an item outright.
...
- At 1st [echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon), each hero starts with a 1st-[echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon) [trinket](scc.v1:mcdm.heroes.v1/rule.treasure/trinket).
- At 2nd [echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon), each hero starts with a [leveled treasure](scc.v1:mcdm.heroes.v1/rule.treasure/leveled-treasure) and a 1st-[echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon) [trinket](scc.v1:mcdm.heroes.v1/rule.treasure/trinket).
- At 3rd [echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon), each hero starts with two [leveled treasures](scc.v1:mcdm.heroes.v1/rule.treasure/leveled-treasure), a 1st-[echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon) [trinket](scc.v1:mcdm.heroes.v1/rule.treasure/trinket), and a 2nd-[echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon) [trinket](scc.v1:mcdm.heroes.v1/rule.treasure/trinket).
- At 4th [echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon), each hero starts with two [leveled treasures](scc.v1:mcdm.heroes.v1/rule.treasure/leveled-treasure), a 1st-[echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon) [trinket](scc.v1:mcdm.heroes.v1/rule.treasure/trinket), a 2nd-[echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon) [trinket](scc.v1:mcdm.heroes.v1/rule.treasure/trinket), and a 3rd-[echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon) [trinket](scc.v1:mcdm.heroes.v1/rule.treasure/trinket).

The players can choose their hero's treasures, and can replace any [leveled treasure](scc.v1:mcdm.heroes.v1/rule.treasure/leveled-treasure) or [trinket](scc.v1:mcdm.heroes.v1/rule.treasure/trinket) for a [consumable](scc.v1:mcdm.heroes.v1/rule.treasure/consumable) treasure of the hero's [echelon](scc.v1:mcdm.heroes.v1/rule.general/echelon) or lower.

#### Making New Treasures

You can easily create new types of [leveled treasures](scc.v1:mcdm.heroes.v1/rule.treasure/leveled-treasure) for heroes to find using the [enhancements](scc.v1:mcdm.heroes.v1/rule.treasure/enhancement) from the Imbue Treasure project in Chapter 12: [Downtime Projects](scc.v1:mcdm.heroes.v1/chapter/downtime-projects).

You can also take any of the treasures in this book and easily reskin them. Do you wish Gecko Gloves were actually boots? Just change the description and the Hands keywords and you're good to go. Do you want the Icemaker Maul to be a dagger that creates pools of acid instead of an ice field? Change the Heavy Weapon keyword and swap the [damage types](scc.v1:mcdm.heroes.v1/rule.damage/damage-type), and you're ready to rock! Simply changing keywords, damage, and descriptions for treasures isn't going to break the game.
...
You can set limits on the number of [retainers](scc.v1:mcdm.heroes.v1/rule.general/retainer) the heroes can have in their service. For a large group of heroes, having too many [retainers](scc.v1:mcdm.heroes.v1/rule.general/retainer) can make combat complex, long, and unwieldy. Likewise, [retainers](scc.v1:mcdm.heroes.v1/rule.general/retainer) are a great way to help a smaller group of heroes stand up to larger challenges. In general, it's a good idea to use [retainers](scc.v1:mcdm.heroes.v1/rule.general/retainer) to help the heroes get the size of their party up to four but no larger than seven.
...
You can award [hero tokens](scc.v1:mcdm.heroes.v1/rule.resource/hero-token) to the players for taking risks with their heroes beyond what the game typically expects of them. For instance, battling a group of monsters is part of the game and doesn't earn a [hero token](scc.v1:mcdm.heroes.v1/rule.resource/hero-token). However, the following activities might:
...
A successful combat encounter in which the party's [objectives](scc.v1:mcdm.heroes.v1/rule.combat/objective) are achieved earns each hero 1 [Victory](scc.v1:mcdm.heroes.v1/rule.resource/victories). Particularly difficult encounters are worth 2 [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) when completed successfully. *Draw Steel: Monsters* has more information about [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) and combat difficulty.

##### Montage Tests

Each hero earns 1 [Victory](scc.v1:mcdm.heroes.v1/rule.resource/victories) when they achieve total success on an easy or moderate [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test), and 2 [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) for total success on a hard [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test). They earn 1 [Victory](scc.v1:mcdm.heroes.v1/rule.resource/victories) if they achieve a partial success on a moderate or hard [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test).

##### Negotiation

Each hero earns 1 [Victory](scc.v1:mcdm.heroes.v1/rule.resource/victories) if the party ends a Negotiation with an [NPC](scc.v1:mcdm.heroes.v1/rule.general/npc)'s interest at 3 or higher, with that interest 2 or more higher than it started, and with agreement on a deal.

##### Hazards and Traps

If the heroes overcome a complicated hazard or trap that required multiple [tests](scc.v1:mcdm.heroes.v1/rule.test/test) to detect and survive, each earns 1 [Victory](scc.v1:mcdm.heroes.v1/rule.resource/victories).

##### Puzzles

If the heroes solve a complicated puzzle that feels to you as if it would take most people at least 10 minutes to complete, each earns 1 [Victory](scc.v1:mcdm.heroes.v1/rule.resource/victories).

##### Story Goals

If the heroes achieve a major story goal that accomplishes a quest, such as saving a prince trapped by an evil baron or stopping a necromancer from performing a world-ending ritual, each earns 1 [Victory](scc.v1:mcdm.heroes.v1/rule.resource/victories).

##### Clever Thinking

If the heroes use clever thinking to easily and surprisingly overcome or bypass a combat encounter, a negotiation, a [montage test](scc.v1:mcdm.heroes.v1/rule.test/montage-test), a trap, a puzzle, or some other challenge that would have awarded them 1 or more [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) in a more difficult fashion, award each character the [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories) they would have earned had they faced and overcome the problem head on.
