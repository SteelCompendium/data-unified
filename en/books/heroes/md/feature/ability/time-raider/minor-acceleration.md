...
*You fill yourself or an ally with a burst of [speed](scc.v1:mcdm.heroes.v1/rule.character/speed).*

| **Psionic, [Melee](scc.v1:mcdm.heroes.v1/rule.combat/melee)** | Maneuver               |
|-------------------|------------------------|
