...
| **Chronopathy, Psionic, [Melee](scc.v1:mcdm.heroes.v1/rule.combat/melee)** |  **[Main action](scc.v1:mcdm.heroes.v1/rule.combat/turn)** |
|---------------------------------|-----------------:|
| **📏 [Melee](scc.v1:mcdm.heroes.v1/rule.combat/melee) 2**                  | **🎯 One enemy** |

**Effect:** The target has [damage weakness](scc.v1:mcdm.heroes.v1/rule.damage/damage-weakness) 5 until the end of your next [turn](scc.v1:mcdm.heroes.v1/rule.combat/turn). Whenever the target takes damage while they have this weakness, they are [knocked prone](scc.v1:mcdm.heroes.v1/condition/prone).

**Strained:** This ability gains the [Strike](scc.v1:mcdm.heroes.v1/rule.combat/strike) keyword as the vision hurts the target's psyche. You make a [power roll](scc.v1:mcdm.heroes.v1/rule.dice/power-roll), then are [weakened](scc.v1:mcdm.heroes.v1/condition/weakened) (save ends).
