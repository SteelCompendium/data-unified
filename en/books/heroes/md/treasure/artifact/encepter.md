...
**Shining [Presence](scc.v1:mcdm.heroes.v1/rule.character/presence):** The one who wields the Encepter is always cast in a brilliant glow. Any [power roll](scc.v1:mcdm.heroes.v1/rule.dice/power-roll) made by the wielder that uses [Presence](scc.v1:mcdm.heroes.v1/rule.character/presence) automatically achieves a tier 3 outcome, though the wielder can still roll in an attempt to score a critical success or [critical hit](scc.v1:mcdm.heroes.v1/rule.combat/critical-hit).

**Champion's Lasso:** As a [free maneuver](scc.v1:mcdm.heroes.v1/rule.combat/free-maneuver), the wielder of the scepter can trigger a glowing line of light that traces their path as they move, or can dismiss the glowing line. If the wielder crosses over this line, each creature and object of the wielder's choice enclosed inside the line and within 2 squares above and below it are considered lassoed by the Encepter. Creatures remain lassoed until the lasso is released or until a new line is drawn.

**Dominion:** Each creature lassoed by the Encepter is [restrained](scc.v1:mcdm.heroes.v1/condition/restrained) and can't [teleport](scc.v1:mcdm.heroes.v1/movement/teleport). A creature caught in midair while lassoed stays in place rather than falling.
