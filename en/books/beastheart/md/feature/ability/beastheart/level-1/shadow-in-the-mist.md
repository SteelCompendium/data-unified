...
effects:
    ...
    - cost: Spend 1 Ferocity
      effect: You can move up to a number of squares equal to twice your Intuition score and ignore [difficult terrain](scc.v1:mcdm.heroes.v1/movement/difficult-terrain) during this movement.
