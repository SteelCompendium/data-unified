...
keywords:
    ...
    - Void
level: "2"
name: '[There Is No Space Between](scc:mcdm.heroes.v1/feature.ability.elementalist.level-2/there-is-no-space-between)'
scc: mcdm.heroes.v1/feature.ability.elementalist.level-2/there-is-no-space-between-scc-mcdm-heroes-v1-feature-ability-elementalist-level-2-there-is-no-space-between
target: Special
type: ability
---
