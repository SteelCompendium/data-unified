...
Once on each subsequent turn, you can use a free maneuver to move the machine a number of squares up to your [Intuition](scc:mcdm.heroes.v1/rule.character/intuition) score then repeat the power roll.
