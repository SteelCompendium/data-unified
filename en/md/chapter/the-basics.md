...
**Alyssa (playing Jorn, a [tactician](scc.v1:mcdm.heroes.v1/class/tactician)):** *I'm going to hang out at the back of the group with my warhammer drawn. I want to be ready in case any of those skeletons we snuck by on the lower levels make their way up the stairs.*

**Matt (playing Linn, a [talent](scc.v1:mcdm.heroes.v1/class/talent)):** *Linn uses her [Minor Telekinesis](scc.v1:mcdm.heroes.v1/feature.ability.talent.level-1/minor-telekinesis) ability to sweep up the glass on the floor and form a path free of glass that goes from the door to the dais.*

**James (playing Korvo, a [shadow](scc.v1:mcdm.heroes.v1/class/shadow)):** *I'll light a torch as I step into the room. Is there anything new we can see now?*
...
**Grace (playing Val, a [conduit](scc.v1:mcdm.heroes.v1/class/conduit)):** *Before anyone steps on them, I want to examine the symbols and figure out what they mean.*

**Director:** *Okay, well for that, I need you to make an easy [Reason](scc.v1:mcdm.heroes.v1/rule.character/reason) [test](scc.v1:mcdm.heroes.v1/rule.test/test).*
...
**Director:** *The whole tower starts to sway as the sarcophagus lids crash to the floor and clawed undead hands emerge from within. Six decaying [devils](scc.v1:mcdm.heroes.v1/ancestry/devil), each tattooed with glowing green runes, rise. They're eager for violence.*
...
Sometimes the rules tell you to divide a number in half. Whenever you divide an odd number in half and it results in a decimal, round the result down to the nearest whole number. For instance, if a [tactician](scc.v1:mcdm.heroes.v1/class/tactician) takes 7 damage and uses the Parry ability in response—a [triggered action](scc.v1:mcdm.heroes.v1/rule.combat/triggered-action) that halves the damage—then the damage is reduced to 3.
...
The things a hero can achieve at the end of the story are far more daring and impactful than what they do at the start, and the final showdown against a villain's forces is more deadly and desperate than the first. The rules of the game help build a heroic narrative in this same fashion, making use of the four most important mechanics for building heroic narratives: [Victories](scc.v1:mcdm.heroes.v1/rule.resource/victories), [Experience](scc.v1:mcdm.heroes.v1/rule.resource/experience), [Heroic Resources](scc.v1:mcdm.heroes.v1/rule.resource/heroic-resource), and [Recoveries](scc.v1:mcdm.heroes.v1/rule.health/recoveries).

#### Recoveries

[Recoveries](scc.v1:mcdm.heroes.v1/rule.health/recoveries) represent the number of times your hero can take a breather and keep fighting. Spending [Recoveries](scc.v1:mcdm.heroes.v1/rule.health/recoveries) lets you regain [Stamina](scc.v1:mcdm.heroes.v1/rule.health/stamina)—the measure of any creature's physical vitality and capacity to shrug off or avoid [damage](scc.v1:mcdm.heroes.v1/rule.damage/damage) (see [Stamina](scc.v1:mcdm.heroes.v1/rule.health/stamina) in [Combat](scc.v1:mcdm.heroes.v1/chapter/combat)). Running out of [Recoveries](scc.v1:mcdm.heroes.v1/rule.health/recoveries) means your hero has reached their uttermost limit.

When you spend a [Recovery](scc.v1:mcdm.heroes.v1/rule.health/recoveries), you regain [Stamina](scc.v1:mcdm.heroes.v1/rule.health/stamina) equal to your **[recovery value](scc.v1:mcdm.heroes.v1/rule.health/recoveries)**, which is one-third your [Stamina](scc.v1:mcdm.heroes.v1/rule.health/stamina) maximum. You can spend your [Recoveries](scc.v1:mcdm.heroes.v1/rule.health/recoveries) with a special maneuver (see below), or you might do so with a little [supernatural](scc.v1:mcdm.heroes.v1/rule.general/supernatural) help from a [conduit](scc.v1:mcdm.heroes.v1/class/conduit), a boost of adrenaline from an allied [tactician](scc.v1:mcdm.heroes.v1/class/tactician), or inspiration from your party's [troubadour](scc.v1:mcdm.heroes.v1/class/troubadour).

##### Spending Recoveries

During combat encounters and similarly dangerous situations when time is tracked in rounds (see Combat), you can use the [Catch Breath](scc.v1:mcdm.heroes.v1/feature.common.maneuvers/catch-breath) maneuver to regain [Stamina](scc.v1:mcdm.heroes.v1/rule.health/stamina). (See [Catch Breath](scc.v1:mcdm.heroes.v1/feature.common.maneuvers/catch-breath) in Maneuvers for more information.) Some heroes have abilities that allow them or their allies to spend more [Recoveries](scc.v1:mcdm.heroes.v1/rule.health/recoveries) without using the [Catch Breath](scc.v1:mcdm.heroes.v1/feature.common.maneuvers/catch-breath) maneuver.

Outside of combat and other dangerous situations, you can spend [Recoveries](scc.v1:mcdm.heroes.v1/rule.health/recoveries) freely.

##### Regaining Recoveries

You regain all lost [Recoveries](scc.v1:mcdm.heroes.v1/rule.health/recoveries) when you finish a [respite](scc.v1:mcdm.heroes.v1/rule.resource/respite) (see below).
