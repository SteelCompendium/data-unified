---
features:
    - body: Whenever the sporeling makes a strike against a creature while rampaging, the sporeling can cause the target to be [slowed](scc:mcdm.heroes.v1/condition/slowed) until the end of the target's next turn.
      level: 3
      name: Slowing Spores
