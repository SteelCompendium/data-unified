---
features:
    - body: The dragon thickens the fog of their Gloaming Wyrmscale Aura trait and the horrors within it. Each creature in the area takes a bane on strikes made against the dragon until the start of the dragon's next turn.
      cost: 3 Malice
      icon: ⭐️
    ...
    - body: The dragon manifests four 2 cubes of nightmarish apparitions anywhere on the encounter map. Each creature in the area when it appears makes an **Intuition test**.
      ...
      power_roll:
        tiers:
            high: 6 damage
            low: 14 damage; dazed (save ends)
            mid: 11 damage; dazed (EoT)
